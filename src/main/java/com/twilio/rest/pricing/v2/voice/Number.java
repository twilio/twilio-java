...
public class Number extends Resource {
    ...
    private Number(
            ...
            @JsonProperty("inbound_call_price") final InboundCallPrice inboundCallPrice,
            ...
            @JsonProperty("outbound_call_prices") final List<OutboundCallPriceWithOrigin> outboundCallPrices,
