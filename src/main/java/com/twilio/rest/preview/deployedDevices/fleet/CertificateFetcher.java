...
public class CertificateFetcher extends Fetcher<Certificate> {
    ...
    public CertificateFetcher(final String pathFleetSid, final String pathSid){
    ...
    @Override
    public Certificate fetch(final TwilioRestClient client) {
        ...
        if (response == null) {
        throw new ApiConnectionException("Certificate fetch failed: Unable to connect to server");
