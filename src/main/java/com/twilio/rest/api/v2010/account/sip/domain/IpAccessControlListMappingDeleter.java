...
public class IpAccessControlListMappingDeleter
    extends Deleter<IpAccessControlListMapping> {

    private String pathAccountSid;
    private String pathDomainSid;
    private String pathSid;

    public IpAccessControlListMappingDeleter(
    ...
    private Response makeRequest(final TwilioRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "IpAccessControlListMapping delete failed: Unable to connect to server"
            );
