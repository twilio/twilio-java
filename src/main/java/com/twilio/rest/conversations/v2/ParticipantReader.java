...
public class ParticipantReader
    ...
    public ParticipantReader setPageToken(final String pageToken) {
    ...
    > readWithResponse(final TwilioRestClient client) {
        ...
        Page<Participant.ListParticipantResponse> page = Page.fromJson(
            "participants",
            response.getContent(),
            Participant.ListParticipantResponse.class,
            client.getObjectMapper()
        );
        ResourceSet<Participant.ListParticipantResponse> resourceSet =
    ...
    @Override
    public ResourceSet<Participant.ListParticipantResponse> read(
        final TwilioRestClient client
    ) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<Participant.ListParticipantResponse> firstPage(
        final TwilioRestClient client
    ) {
        Request request = buildFirstPageRequest(client);
    ...
    public TwilioResponse<
        Page<Participant.ListParticipantResponse>
    ...
    private Page<Participant.ListParticipantResponse> pageForRequest(
        final TwilioRestClient client,
        final Request request
    ) {
        Response response = makeRequest(client, request);
    ...
    @Override
    public Page<Participant.ListParticipantResponse> previousPage(
    ...
    @Override
    public Page<Participant.ListParticipantResponse> nextPage(
        final Page<Participant.ListParticipantResponse> page,
        final TwilioRestClient client
    ) {
        String path = "/v2/Conversations/{ConversationSid}/Participants";
    ...
    @Override
    public Page<Participant.ListParticipantResponse> getPage(
