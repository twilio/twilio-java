...
public class ServiceTest {
    ...
    public void testFetchRequest() {
        ...
        try {
            Service.fetcher("KSXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX").fetch(tw);
    ...
    public void testCreateRequest() {
        ...
        try {
            Service.creator("unique_name").create(tw);
            fail("Expected TwilioException to be thrown for 500");
        } catch (TwilioException e) {}
    }
    ...
    public void testDeleteRequest() {
        ...
        try {
            Service.deleter("KSXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX").delete(tw);
            fail("Expected TwilioException to be thrown for 500");
        } catch (TwilioException e) {}
    }
    ...
    public void testUpdateRequest() {
        ...
        try {
            Service.updater("KSXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX").update(tw);
            fail("Expected TwilioException to be thrown for 500");
        } catch (TwilioException e) {}
    }
