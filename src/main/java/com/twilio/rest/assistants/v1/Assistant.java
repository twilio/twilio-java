...
public class Assistant extends Resource {
    ...
    public static class AssistantsV1ServiceTool {
        ...
        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("meta")
        @Getter private final Object meta;
        ...
        @Getter private final Boolean requiresAuth;
        ...
        @Getter private final ZonedDateTime dateUpdated;
    ...
    public static class AssistantsV1ServiceCustomerAi {
        ...
        @Getter private final Boolean perceptionEngineEnabled;

        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("personalization_engine_enabled")
        @Getter private final Boolean personalizationEngineEnabled;
    ...
    public static class AssistantsV1ServiceUpdateAssistantRequest {
        ...
        @Getter private final AssistantsV1ServiceCustomerAi customerAi;
        ...
        @Getter private final String personalityPrompt;

        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("segment_credential")
        @Getter private final AssistantsV1ServiceSegmentCredential segmentCredential;
    ...
    public static class AssistantsV1ServiceSegmentCredential {
        ...
        @Getter private final String profileApiKey;

        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("space_id")
        @Getter private final String spaceId;

        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("write_key")
        @Getter private final String writeKey;
    ...
    public static class AssistantsV1ServiceKnowledge {
        ...
        @Getter private final Object knowledgeSourceDetails;
        ...
        @Getter private final String embeddingModel;
...
private Assistant(
    ...
    final List<AssistantsV1ServiceKnowledge> knowledge, 
    @JsonProperty("model")
    final String model, 
    @JsonProperty("name")
    final String name, 
    ...
    @JsonProperty("tools")
    final List<AssistantsV1ServiceTool> tools, 
    @JsonProperty("url")
    final String url
){
    this.accountSid = accountSid;
