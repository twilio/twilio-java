...
public class ParticipantReader extends Reader<Participant> {
     ...
     * 
     * @param participantType The participant_type
     * @return this
     */
    public ParticipantReader setParticipantType(final Participant.ParticipantType participantType) {
    ...
    private void addQueryParams(final Request request) {
        if (participantType != null) {
            request.addQueryParam("ParticipantType", participantType.toString());
        }
