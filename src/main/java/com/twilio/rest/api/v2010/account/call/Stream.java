...
public class Stream extends Resource {
    ...
    /**
     * Create a StreamUpdater to execute update.
     *
     * @param pathAccountSid The SID of the Account that created this resource
     * @param pathCallSid The SID of the Call the resource is associated with
     * @param pathSid The SID of the Stream resource, or the `name`
     * @param status The status. Must have the value `stopped`
     * @return StreamUpdater capable of executing the update
     */
    public static StreamUpdater updater(final String pathAccountSid,
                                        final String pathCallSid,
     ...
     * @return StreamUpdater capable of executing the update
     */
    public static StreamUpdater updater(final String pathCallSid,
                                        final String pathSid,
                                        final Stream.UpdateStatus status) {
     ...
     *
     * @return The SID of the Stream resource.
     */
