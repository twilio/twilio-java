...
public class KeyTest {
    ...
    public void testFetchRequest() {
        ...
        try {
            Key.fetcher("FLXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", "KYXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX").fetch(tw);
    ...
    public void testFetchResponse() {
        ...
        assertNotNull(Key.fetcher("FLXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", "KYXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX").fetch(tw));
    }
    ...
    public void testDeleteRequest() {
        ...
        try {
            Key.deleter("FLXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", "KYXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX").delete(tw);
            fail("Expected TwilioException to be thrown for 500");
        } catch (TwilioException e) {}
    }
    ...
    public void testCreateRequest() {
        ...
        try {
            Key.creator("FLXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX").create(tw);
            fail("Expected TwilioException to be thrown for 500");
        } catch (TwilioException e) {}
    }
    ...
    public void testReadRequest() {
        ...
        try {
            Key.reader("FLXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX").read(tw);
            fail("Expected TwilioException to be thrown for 500");
        } catch (TwilioException e) {}
    }
    ...
    public void testReadEmptyResponse() {
        ...
        assertNotNull(Key.reader("FLXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX").read(tw));
    }
    ...
    public void testUpdateRequest() {
        ...
        try {
            Key.updater("FLXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", "KYXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX").update(tw);
            fail("Expected TwilioException to be thrown for 500");
        } catch (TwilioException e) {}
    }
