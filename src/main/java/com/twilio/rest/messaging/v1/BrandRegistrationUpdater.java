...
public class BrandRegistrationUpdater extends Updater<BrandRegistration> {
    ...
    /**
     * Construct a new BrandRegistrationUpdater.
     *
     ...
     * @return Updated BrandRegistration
     */
    @Override
    ...
    public BrandRegistration update(final TwilioRestClient client) {
        Request request = new Request(
            ...
            "/v1/a2p/BrandRegistrations/" + this.pathSid + ""
        );
        ...
        if (response == null) {
            throw new ApiConnectionException("BrandRegistration update failed: Unable to connect to server");
