...
public class SyncListPermission extends Resource {
     ...
     */
    public static SyncListPermissionFetcher fetcher(final String serviceSid, 
     ...
     */
    public static SyncListPermissionDeleter deleter(final String serviceSid, 
                                                    final String listSid, 
                                                    final String identity) {
     ...
     */
    public static SyncListPermissionReader reader(final String serviceSid, 
                                                  final String listSid) {
     ...
     */
    public static SyncListPermissionUpdater updater(final String serviceSid, 
                                                    final String listSid, 
                                                    final String identity, 
                                                    final Boolean read, 
                                                    final Boolean write, 
