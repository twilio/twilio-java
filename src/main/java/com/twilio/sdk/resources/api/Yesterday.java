...
import com.twilio.sdk.readers.api.YesterdayReader;
...
public class Yesterday extends SidResource {
    ...
    @JsonCreator
    private Yesterday(@JsonProperty("account_sid") final String accountSid, 
