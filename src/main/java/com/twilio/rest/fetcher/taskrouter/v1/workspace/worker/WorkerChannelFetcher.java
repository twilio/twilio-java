...
package com.twilio.rest.fetcher.taskrouter.v1.workspace.worker;
...
import com.twilio.rest.resource.taskrouter.v1.workspace.worker.WorkerChannel;
...
public class WorkerChannelFetcher extends Fetcher<WorkerChannel> {
     ...
     * @param sid The sid
     */
    public WorkerChannelFetcher(final String workspaceSid, 
