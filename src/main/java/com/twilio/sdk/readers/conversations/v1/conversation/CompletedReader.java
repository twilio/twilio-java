...
import com.twilio.sdk.resources.conversations.v1.conversation.Completed;

public class CompletedReader extends Reader<Completed> {
    /**
    ...
    public Page<Completed> firstPage(final TwilioRestClient client) {
     ...
     */
    @Override
    public Page<Completed> nextPage(final Page<Completed> page, 
     ...
     */
    private Page<Completed> pageForRequest(final TwilioRestClient client, final Request request) {
