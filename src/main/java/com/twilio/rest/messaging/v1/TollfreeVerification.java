...
public class TollfreeVerification extends Resource {
    private static final long serialVersionUID = 105488559689699L;
    ...
    public enum OptInType {
        ...
        /**
         * Generate a OptInType from a string.
         * @param value string value
         * @return generated OptInType
         */
        @JsonCreator
    ...
    /**
     * Create a TollfreeVerificationFetcher to execute fetch.
     *
     * @param pathSid Tollfree Verification Sid
     * @return TollfreeVerificationFetcher capable of executing the fetch
     */
    ...
    /**
     * Create a TollfreeVerificationReader to execute read.
     *
     * @return TollfreeVerificationReader capable of executing the read
     */
    ...
    /**
     * Create a TollfreeVerificationCreator to execute create.
     *
     ...
     * @return TollfreeVerificationCreator capable of executing the create
     */
    public static TollfreeVerificationCreator creator(final String businessName,
    ...
    /**
     * Converts a JSON String into a TollfreeVerification object using the provided
     * ObjectMapper.
     *
    ...
    /**
     * Converts a JSON InputStream into a TollfreeVerification object using the
    ...
    @JsonCreator
    private TollfreeVerification(@JsonProperty("sid")
                                 final String sid,
     ...
     *
     * @return Tollfree Verification Sid
     */
     ...
     *
     * @return Customer's Profile Bundle BundleSid
     */
     ...
     *
     * @return Tollfree TrustProduct Bundle BundleSid
     */
     ...
     *
     * @return The SID of the Regulated Item
     */
     ...
     *
     * @return The name of the business or organization using the Tollfree number
     */
    ...
    /**
     * Returns The address of the business or organization using the Tollfree
     * number.
     *
     * @return The address of the business or organization using the Tollfree number
     */
     ...
     *
     * @return The city of the business or organization using the Tollfree number
     */
    ...
    /**
     * Returns The state/province/region of the business or organization using the
     * Tollfree number.
     *
     * @return The state/province/region of the business or organization using the
     *         Tollfree number
     */
    ...
    /**
     * Returns The postal code of the business or organization using the Tollfree
     * number.
     *
     * @return The postal code of the business or organization using the Tollfree
     *         number
     */
    ...
    /**
     * Returns The country of the business or organization using the Tollfree
     * number.
     *
     * @return The country of the business or organization using the Tollfree number
     */
    ...
    /**
     * Returns The website of the business or organization using the Tollfree
     * number.
     *
     * @return The website of the business or organization using the Tollfree number
     */
    ...
    /**
     * Returns The first name of the contact for the business or organization using
     * the Tollfree number.
     *
     * @return The first name of the contact for the business or organization using
     *         the Tollfree number
     */
    ...
    /**
     * Returns The last name of the contact for the business or organization using
     * the Tollfree number.
     *
     * @return The last name of the contact for the business or organization using
     *         the Tollfree number
     */
    ...
    /**
     * Returns The email address of the contact for the business or organization
     * using the Tollfree number.
     *
     * @return The email address of the contact for the business or organization
     *         using the Tollfree number
     */
    ...
    /**
     * Returns The phone number of the contact for the business or organization
     * using the Tollfree number.
     *
     * @return The phone number of the contact for the business or organization
     *         using the Tollfree number
     */
    ...
    /**
     * Returns The email address to receive the notification about the verification
     * result. .
     *
     * @return The email address to receive the notification about the verification
     *         result.
     */
    ...
    /**
     * Returns The category of the use case for the Tollfree Number. List as many
     * are applicable..
     *
     * @return The category of the use case for the Tollfree Number. List as many
     *         are applicable.
     */
    ...
    /**
     * Returns Further explaination on how messaging is used by the business or
     * organization.
     *
     * @return Further explaination on how messaging is used by the business or
     *         organization
     */
     ...
     *
     * @return An example of message content, i.e. a sample message
     */
    ...
    /**
     * Returns Link to an image that shows the opt-in workflow. Multiple images
     * allowed and must be a publicly hosted URL.
     *
     * @return Link to an image that shows the opt-in workflow. Multiple images
     *         allowed and must be a publicly hosted URL
     */
     ...
     *
     * @return Describe how a user opts-in to text messages
     */
     ...
     *
     * @return Estimate monthly volume of messages from the Tollfree Number
     */
     ...
     *
     * @return Additional information to be provided for verification
     */
    ...
    /**
     * Returns The SID of the Phone Number associated with the Tollfree
     * Verification.
     *
     * @return The SID of the Phone Number associated with the Tollfree Verification
     */
     ...
     *
     * @return The compliance status of the Tollfree Verification record.
     */
     ...
     *
     * @return The absolute URL of the Tollfree Verification
     */
    ...
    /**
     * Returns The URLs of the documents associated with the Tollfree Verification
     * resource.
     *
     * @return The URLs of the documents associated with the Tollfree Verification
     *         resource
     */
