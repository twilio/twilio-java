...
public class TypeDeleter extends Deleter<Type> {

    private String pathType;
    private String pathIdOrUniqueName;

    public TypeDeleter(final String pathType, final String pathIdOrUniqueName) {
    ...
    private Response makeRequest(final TwilioRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "Type delete failed: Unable to connect to server"
            );
