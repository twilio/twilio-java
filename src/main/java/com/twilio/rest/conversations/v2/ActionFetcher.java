...
public class ActionFetcher extends Fetcher<Action.FetchActionResponse> {

    private String pathConversationId;
    private String pathActionId;
    ...
    public ActionFetcher(
        ...
        this.pathActionId = pathActionId;
    }
    ...
    private Response makeRequest(final TwilioRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "Action fetch failed: Unable to connect to server"
            );
    ...
    @Override
    public Action.FetchActionResponse fetch(final TwilioRestClient client) {
        Response response = makeRequest(client);
        return Action.FetchActionResponse.fromJson(
            response.getStream(),
            client.getObjectMapper()
        );
    }
    ...
    @Override
    public TwilioResponse<Action.FetchActionResponse> fetchWithResponse(
        final TwilioRestClient client
    ) {
        Response response = makeRequest(client);
        Action.FetchActionResponse content =
            Action.FetchActionResponse.fromJson(
                response.getStream(),
                client.getObjectMapper()
            );
