...
public class NationalReader extends Reader<National> {
    ...
    public NationalReader(final String countryCode){
        this.countryCode = countryCode;
    }
    public NationalReader(final String accountSid, final String countryCode){
    ...
    @Override
    public Page<National> previousPage(final Page<National> page, final TwilioRestClient client) {
        Request request = new Request(
            HttpMethod.GET,
    ...
    @Override
    public Page<National> nextPage(final Page<National> page, final TwilioRestClient client) {
        Request request = new Request(
            HttpMethod.GET,
