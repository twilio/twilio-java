...
public class DomainValidateDnFetcher extends Fetcher<DomainValidateDn> {

    private String pathDomainSid;

    public DomainValidateDnFetcher(final String pathDomainSid) {
    ...
    private Response makeRequest(final TwilioRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "DomainValidateDn fetch failed: Unable to connect to server"
            );
