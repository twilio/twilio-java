...
public class SipCredential extends SidResource {
    ...
    @JsonCreator
    public SipCredential(@JsonProperty("sid") final String sid,
    ...
    public static SipCredentialCreator create(final String credentialListSid, final String username, final String password) {
        return new SipCredentialCreator(credentialListSid, username, password);
    }

    public static SipCredentialCreator create(final SipCredentialList target, final String username, final String password) {
    ...
    public static SipCredentialUpdater update(final SipCredentialList targetCredentialList, final String sid, final String password) {
