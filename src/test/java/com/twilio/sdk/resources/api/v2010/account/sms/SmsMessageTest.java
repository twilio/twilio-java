...
public class SmsMessageTest {
    ...
    public void testCreateRequest() {
        ...
        try {
            SmsMessage.create("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", new com.twilio.sdk.type.PhoneNumber("+123456789"), new com.twilio.sdk.type.PhoneNumber("+987654321"), "body").execute();
