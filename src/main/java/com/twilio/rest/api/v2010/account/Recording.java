...
public class Recording extends Resource {
    ...
    public static RecordingFetcher fetcher(final String accountSid, final String sid){
    ...
    public static RecordingDeleter deleter(final String accountSid, final String sid){
