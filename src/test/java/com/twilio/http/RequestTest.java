...
public class RequestTest {
    ...
    public void testAddQueryDateTimeRangeClosedNotUTC() throws MalformedURLException {
        ...
        r.addQueryDateTimeRange("baz", Range.closed(
            ZonedDateTime.of(2014, 1, 10, 14, 0, 0, 0, ZoneId.of("America/Chicago")).withZoneSameInstant(ZoneOffset.UTC),
            ZonedDateTime.of(2014, 6, 1, 16, 0, 0, 0, ZoneId.of("America/Chicago")).withZoneSameInstant(ZoneOffset.UTC)));
        URL url = r.constructURL();
