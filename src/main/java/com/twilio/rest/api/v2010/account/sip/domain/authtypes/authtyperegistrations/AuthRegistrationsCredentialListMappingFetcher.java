    ...
    extends Fetcher<AuthRegistrationsCredentialListMapping>
{
    ...
    private Response makeRequest(final TwilioRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "AuthRegistrationsCredentialListMapping fetch failed: Unable to connect to server"
            );
    ...
    @Override
    public AuthRegistrationsCredentialListMapping fetch(
    ...
    @Override
    public TwilioResponse<AuthRegistrationsCredentialListMapping> fetchWithResponse(
        final TwilioRestClient client
    ) {
        Response response = makeRequest(client);
