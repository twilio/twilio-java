...
public class SourceIpMappingReader extends Reader<SourceIpMapping> {
    ...
    public ResourceSetResponse<SourceIpMapping> readWithResponse(
        final TwilioRestClient client
    ) {
        Request request = buildFirstPageRequest(client);
        Response response = makeRequest(client, request);
        Page<SourceIpMapping> page = Page.fromJson(
            "source_ip_mappings",
            response.getContent(),
            SourceIpMapping.class,
            client.getObjectMapper()
        );
        ResourceSet<SourceIpMapping> resourceSet = new ResourceSet<>(
            this,
            client,
            page
        );
    ...
    public TwilioResponse<Page<SourceIpMapping>> firstPageWithResponse(
        final TwilioRestClient client
    ) {
        Request request = buildFirstPageRequest(client);
        Response response = makeRequest(client, request);
