...
public class ChannelTest {
    ...
    public void testCreateRequest() {
        ...
        try {
            Channel.creator("BWXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", "PNXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX").create(tw);
