...
public class ParticipantUpdater
    ...
    public ParticipantUpdater setUpdateParticipantInConversationRequest(
        final Participant.UpdateParticipantInConversationRequest updateParticipantInConversationRequest
    ) {
        this.updateParticipantInConversationRequest =
    ...
    @Override
    public Participant.UpdateParticipantResponse update(
        final TwilioRestClient client
    ) {
        Response response = makeRequest(client);
        return Participant.UpdateParticipantResponse.fromJson(
            response.getStream(),
            client.getObjectMapper()
        );
    }
