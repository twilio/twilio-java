...
public class AssignedAddOnExtension extends Resource {
     ...
     */
    public static AssignedAddOnExtensionFetcher fetcher(final String accountSid, 
     ...
     * @return AssignedAddOnExtensionFetcher capable of executing the fetch
     */
    public static AssignedAddOnExtensionFetcher fetcher(final String resourceSid, 
                                                        final String assignedAddOnSid, 
                                                        final String sid) {
     ...
     */
    public static AssignedAddOnExtensionReader reader(final String accountSid, 
                                                      final String resourceSid, 
                                                      final String assignedAddOnSid) {
     ...
     * @return AssignedAddOnExtensionReader capable of executing the read
     */
    public static AssignedAddOnExtensionReader reader(final String resourceSid, 
                                                      final String assignedAddOnSid) {
