...
public class BrandRegistrationReader extends Reader<BrandRegistration> {
    ...
    @Override
    public Page<BrandRegistration> previousPage(
        final Page<BrandRegistration> page,
        final TwilioRestClient client
    ) {
        Request request = new Request(
            HttpMethod.GET,
    ...
    @Override
    public Page<BrandRegistration> nextPage(
        final Page<BrandRegistration> page,
        final TwilioRestClient client
    ) {
        Request request = new Request(
    ...
    @Override
    public Page<BrandRegistration> getPage(
