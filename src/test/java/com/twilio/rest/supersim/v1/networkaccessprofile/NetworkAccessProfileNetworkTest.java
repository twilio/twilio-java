...
public class NetworkAccessProfileNetworkTest {
    ...
    public void testReadRequest() {
        ...
        try {
            NetworkAccessProfileNetwork.reader("HAXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX").read(tw);
    ...
    public void testReadFullResponse() {
        ...
        assertNotNull(NetworkAccessProfileNetwork.reader("HAXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX").read(tw));
    }
    ...
    public void testCreateRequest() {
        ...
        try {
            NetworkAccessProfileNetwork.creator("HAXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", "HWXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX").create(tw);
            fail("Expected TwilioException to be thrown for 500");
        } catch (TwilioException e) {}
    }
    ...
    public void testDeleteRequest() {
        ...
        try {
            NetworkAccessProfileNetwork.deleter("HAXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", "HWXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX").delete(tw);
            fail("Expected TwilioException to be thrown for 500");
        } catch (TwilioException e) {}
    }
    ...
    public void testFetchRequest() {
        ...
        try {
            NetworkAccessProfileNetwork.fetcher("HAXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", "HWXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX").fetch(tw);
            fail("Expected TwilioException to be thrown for 500");
        } catch (TwilioException e) {}
    }
    ...
    public void testFetchResponse() {
        ...
        assertNotNull(NetworkAccessProfileNetwork.fetcher("HAXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", "HWXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX").fetch(tw));
    }
}