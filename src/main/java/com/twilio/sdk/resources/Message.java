...
public class Message extends SidResource {
    ...
    private Message(
        ...
        @JsonProperty("num_segments") final Integer numSegments,
        ...
        @JsonProperty("num_media") final Integer numMedia,
    ...
    public enum Status {
        QUEUED("queued"),SENDING("sending"),SENT("sent"),FAILED("failed"),DELIVERED("delivered"),UNDELIVERED("undelivered"),RECEIVING("receiving"),RECEIVED("received");
