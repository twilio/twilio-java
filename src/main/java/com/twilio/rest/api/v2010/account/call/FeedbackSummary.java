...
public class FeedbackSummary extends Resource {
    ...
    public static FeedbackSummaryCreator creator(
    ...
    public static FeedbackSummaryDeleter deleter(
        final String pathAccountSid,
    ...
    public static FeedbackSummaryFetcher fetcher(
        final String pathAccountSid,
        final String pathSid
    ) {
     ...
     */
    public static FeedbackSummary fromJson(
        final String json,
    ...
    private FeedbackSummary(
        ...
        @JsonProperty("issues") final List<Map<String, Object>> issues,
        @JsonProperty(
    ...
    public boolean equals(final Object o) {
        ...
        return (
            ...
            Objects.equals(
                ...
                other.qualityScoreStandardDeviation
            ) &&
