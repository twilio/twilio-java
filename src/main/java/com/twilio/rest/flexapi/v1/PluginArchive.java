...
public class PluginArchive extends Resource {
     ...
     */
    public static PluginArchive fromJson(final String json, final ObjectMapper objectMapper) {
     ...
     * @return PluginArchive object represented by the provided JSON
     */
    public static PluginArchive fromJson(final InputStream json, final ObjectMapper objectMapper) {
        // Convert all checked exceptions to Runtime
        try {
            return objectMapper.readValue(json, PluginArchive.class);
        } catch (final JsonMappingException | JsonParseException e) {
