...
public abstract class ServicesListResource<T> extends ServicesResource implements Iterable<T> {
	 ...
	 */
	public ServicesListResource(TwilioServiceStatusReadRestClient client) {
	 ...
	 */
	public ServicesListResource(TwilioServiceStatusReadRestClient client, Map<String, String> filters) {
		super(client);
	 ...
	 */
	protected abstract T makeNew(TwilioServiceStatusReadRestClient client,
