...
public class BillingPeriodReader extends Reader<BillingPeriod> {
    ...
    /**
     * Construct a new BillingPeriodReader.
     *
     ...
     * @return BillingPeriod ResourceSet
     */
    @Override
    ...
    public Page<BillingPeriod> firstPage(final TwilioRestClient client) {
        Request request = new Request(
            ...
            "/v1/Sims/" + this.pathSimSid + "/BillingPeriods"
        );
     ...
     */
    @Override
    public Page<BillingPeriod> nextPage(final Page<BillingPeriod> page,
     ...
     */
    @Override
    public Page<BillingPeriod> previousPage(final Page<BillingPeriod> page,
                                            final TwilioRestClient client) {
        Request request = new Request(
            HttpMethod.GET,
    ...
    /**
     * Generate a Page of BillingPeriod Resources for a given request.
     *
     * @param client TwilioRestClient with which to make the request
