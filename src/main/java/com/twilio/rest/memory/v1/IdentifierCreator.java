...
public class IdentifierCreator
    ...
    private Identifier._Identifier identifier;
    ...
    public IdentifierCreator setIdentifier(
        final Identifier._Identifier identifier
    ) {
        this.identifier = identifier;
        return this;
    ...
    private Response makeRequest(final TwilioRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "Identifier creation failed: Unable to connect to server"
            );
    ...
    @Override
    public Identifier.CreateIdentifierResponse create(
        final TwilioRestClient client
    ) {
        Response response = makeRequest(client);
        return Identifier.CreateIdentifierResponse.fromJson(
            response.getStream(),
            client.getObjectMapper()
        );
    }
    ...
    private void addPostParams(final Request request, TwilioRestClient client) {
        ...
        if (identifier != null) {
            request.setBody(Identifier.toJson(identifier, objectMapper));
        }
    }
}
