...
public class CustomerProfilesEvaluationsFetcher extends Fetcher<CustomerProfilesEvaluations> {
    ...
    /**
     * Construct a new CustomerProfilesEvaluationsFetcher.
     *
     ...
     */
    public CustomerProfilesEvaluationsFetcher(final String pathCustomerProfileSid,
     ...
     * @return Fetched CustomerProfilesEvaluations
     */
    @Override
    @SuppressWarnings("checkstyle:linelength")
    public CustomerProfilesEvaluations fetch(final TwilioRestClient client) {
        Request request = new Request(
            HttpMethod.GET,
            Domains.TRUSTHUB.toString(),
            "/v1/CustomerProfiles/" + this.pathCustomerProfileSid + "/Evaluations/" + this.pathSid + ""
        );
