...
public class AssistantTest {
    ...
    public void testFetchRequest() {
        ...
        try {
            Assistant.fetcher("UAXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX").fetch(tw);
    ...
    public void testFetchResponse() {
        ...
        assertNotNull(Assistant.fetcher("UAXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX").fetch(tw));
    }
    ...
    public void testReadEmptyResponse() {
        new NonStrictExpectations() {{
            twilioRestClient.request((Request) any);
            result = new Response("{\"assistants\": [],\"meta\": {\"first_page_url\": \"https://preview.twilio.com/understand/Assistants?PageSize=50&Page=0\",\"key\": \"assistants\",\"next_page_url\": null,\"page\": 0,\"page_size\": 50,\"previous_page_url\": null,\"url\": \"https://preview.twilio.com/understand/Assistants?PageSize=50&Page=0\"}}", TwilioRestClient.HTTP_STATUS_CODE_OK);
            twilioRestClient.getObjectMapper();
            result = new ObjectMapper();
        }};

        assertNotNull(Assistant.reader().read(tw));
    }
    ...
    public void testUpdateRequest() {
        ...
        try {
            Assistant.updater("UAXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX").update(tw);
            fail("Expected TwilioException to be thrown for 500");
        } catch (TwilioException e) {}
    }
