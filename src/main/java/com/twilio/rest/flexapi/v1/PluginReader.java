...
public class PluginReader extends Reader<Plugin> {
    ...
    public ResourceSetResponse<Plugin> readWithResponse(
        final TwilioRestClient client
    ) {
        Request request = buildFirstPageRequest(client);
        Response response = makeRequest(client, request);
        Page<Plugin> page = Page.fromJson(
            "plugins",
            response.getContent(),
            Plugin.class,
            client.getObjectMapper()
        );
        ResourceSet<Plugin> resourceSet = new ResourceSet<>(this, client, page);
    ...
    public TwilioResponse<Page<Plugin>> firstPageWithResponse(
        final TwilioRestClient client
    ) {
        Request request = buildFirstPageRequest(client);
        Response response = makeRequest(client, request);
