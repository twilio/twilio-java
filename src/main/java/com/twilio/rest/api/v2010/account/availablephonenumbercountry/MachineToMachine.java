...
public class MachineToMachine extends Resource {
    ...
    public static MachineToMachineReader reader(final String countryCode){
        return new MachineToMachineReader(countryCode);
    }
    public static MachineToMachineReader reader(final String accountSid, final String countryCode){
        return new MachineToMachineReader(accountSid, countryCode);
    }
