...
public class MediaRecording extends Resource {
     ...
     */
    public static MediaRecording fromJson(
        final String json,
    ...
    private MediaRecording(
        ...
        @JsonProperty("format") final MediaRecording.Format format,
        @JsonProperty("links") final Map<String, String> links,
        @JsonProperty("processor_sid") final String processorSid,
        @JsonProperty("resolution") final String resolution,
        @JsonProperty("source_sid") final String sourceSid,
        @JsonProperty("sid") final String sid,
        @JsonProperty("media_size") final Long mediaSize,
        @JsonProperty("status") final MediaRecording.Status status,
