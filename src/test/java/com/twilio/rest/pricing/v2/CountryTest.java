...
public class CountryTest {
    ...
    public void testFetchResponse() {
        new NonStrictExpectations() {{
            twilioRestClient.request((Request) any);
            result = new Response("{\"country\": \"United States\",\"originating_call_prices\": [{\"base_price\": \"\",\"current_price\": \"0.0085\",\"number_type\": \"local\"},{\"base_price\": \"\",\"current_price\": \"0.022\",\"number_type\": \"toll free\"}],\"iso_country\": \"US\",\"terminating_prefix_prices\": [{\"base_price\": \"\",\"current_price\": \"0.090\",\"destination_prefixes\": [\"1907\"],\"friendly_name\": \"Outbound Trunking Minute - United States - Alaska\",\"origination_prefixes\": [\"ALL\"]},{\"base_price\": \"\",\"current_price\": \"0.013\",\"destination_prefixes\": [\"1808\"],\"friendly_name\": \"Outbound Trunking Minute - United States - Hawaii\",\"origination_prefixes\": [\"ALL\"]},{\"base_price\": \"\",\"current_price\": \"0.013\",\"destination_prefixes\": [\"1800\",\"1844\",\"1855\",\"1866\",\"1877\",\"1888\"],\"friendly_name\": \"Outbound Trunking Minute - United States & Canada - Toll Free\",\"origination_prefixes\": [\"ALL\"]},{\"base_price\": \"\",\"current_price\": \"0.013\",\"destination_prefixes\": [\"1\"],\"friendly_name\": \"Outbound Trunking Minute - United States & Canada\",\"origination_prefixes\": [\"ALL\"]}],\"price_unit\": \"USD\",\"url\": \"https://pricing.twilio.com/v2/Trunking/Countries/US\"}", TwilioRestClient.HTTP_STATUS_CODE_OK);
            twilioRestClient.getObjectMapper();
            result = new ObjectMapper();
        }};
