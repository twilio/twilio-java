...
public class SigningKeyReader extends Reader<SigningKey> {
    ...
    public SigningKeyReader(final String accountSid){
    ...
    private Page<SigningKey> pageForRequest(final TwilioRestClient client, final Request request) {
        Response response = client.request(request);

        if (response == null) {
            throw new ApiConnectionException("SigningKey read failed: Unable to connect to server");
    ...
    @Override
    public Page<SigningKey> previousPage(final Page<SigningKey> page, final TwilioRestClient client) {
        Request request = new Request(
            HttpMethod.GET,
    ...
    @Override
    public Page<SigningKey> nextPage(final Page<SigningKey> page, final TwilioRestClient client) {
        Request request = new Request(
            HttpMethod.GET,
