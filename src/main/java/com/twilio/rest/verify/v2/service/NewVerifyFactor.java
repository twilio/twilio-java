...
public enum FactorType {
    ...
    public static class VerifyPasskeysFactorRequest {
        ...
        @Getter private final NewVerifyFactor.AuthenticatorAttachment authenticatorAttachment;

        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("type")
        @Getter private final NewVerifyFactor.Type type;

        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("response")
        @Getter private final VerifyPasskeysFactorRequestResponse response;
    ...
    public static class VerifyPasskeysFactorRequestResponse {
        ...
        @Getter private final String attestationObject;
        ...
        @Getter private final List<NewVerifyFactor.Transports> transports;
...
private NewVerifyFactor(
    ...
    final String sid, 
    @JsonProperty("status")
    final NewVerifyFactor.Status status, 
    @JsonProperty("url")
    final URI url
){
