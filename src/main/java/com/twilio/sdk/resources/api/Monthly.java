...
import com.twilio.sdk.readers.api.MonthlyReader;
...
public class Monthly extends SidResource {
     ...
     */
    public static MonthlyReader read(final String accountSid) {
     ...
     * @return Monthly object represented by the provided JSON
     */
    public static Monthly fromJson(final String json, final ObjectMapper objectMapper) {
        // Convert all checked exceptions to Runtime
        try {
            return objectMapper.readValue(json, Monthly.class);
    ...
    /**
     * Converts a JSON InputStream into a Monthly object using the provided
     * ObjectMapper
     * 
     ...
     * @return Monthly object represented by the provided JSON
     */
    public static Monthly fromJson(final InputStream json, final ObjectMapper objectMapper) {
        // Convert all checked exceptions to Runtime
        try {
            return objectMapper.readValue(json, Monthly.class);
        } catch (final JsonMappingException | JsonParseException e) {
    ...
    private final Monthly.Category category;
    ...
    @JsonCreator
    private Monthly(@JsonProperty("account_sid") final String accountSid, 
                    @JsonProperty("api_version") final String apiVersion, 
                    @JsonProperty("category") final Monthly.Category category, 
     ...
     * @return The category
     */
    public final Monthly.Category getCategory() {
