...
public class DeploymentReader extends Reader<Deployment> {
    ...
    public ResourceSetResponse<Deployment> readWithResponse(
        final TwilioRestClient client
    ) {
        Request request = buildFirstPageRequest(client);
        Response response = makeRequest(client, request);
        Page<Deployment> page = Page.fromJson(
            "deployments",
            response.getContent(),
            Deployment.class,
            client.getObjectMapper()
        );
        ResourceSet<Deployment> resourceSet = new ResourceSet<>(
            this,
            client,
            page
        );
    ...
    public TwilioResponse<Page<Deployment>> firstPageWithResponse(
        final TwilioRestClient client
    ) {
        Request request = buildFirstPageRequest(client);
        Response response = makeRequest(client, request);
    ...
    private Response makeRequest(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "Deployment read failed: Unable to connect to server"
            );
    ...
    private Page<Deployment> pageForRequest(
        final TwilioRestClient client,
        final Request request
    ) {
        Response response = makeRequest(client, request);
    ...
    @Override
    public Page<Deployment> previousPage(
        final Page<Deployment> page,
        final TwilioRestClient client
    ) {
        Request request = new Request(
            HttpMethod.GET,
    ...
    @Override
    public Page<Deployment> nextPage(
        final Page<Deployment> page,
        final TwilioRestClient client
    ) {
        Request request = new Request(
    ...
    @Override
    public Page<Deployment> getPage(
