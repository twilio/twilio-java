...
[![Maven Central](https://img.shields.io/maven-central/v/com.twilio.sdk/twilio.svg)](https://central.sonatype.com/artifact/com.twilio.sdk/twilio)
...
`twilio-java` uses Maven. At present the jars _are_ available from a public [maven](https://central.sonatype.com/artifact/com.twilio.sdk/twilio) repository.
...
```groovy
implementation "com.twilio.sdk:twilio:13.X.X"
```
