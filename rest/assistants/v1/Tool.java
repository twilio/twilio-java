...
public class Tool extends Resource {
    ...
    public static class AssistantsV1ServiceCreatePolicyRequest {
        ...
        @Getter private final Object policyDetails;
    ...
    public static class AssistantsV1ServiceUpdateToolRequest {
        ...
        @Getter private final String assistantId;
        ...
        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("policy")
        @Getter private final AssistantsV1ServiceCreatePolicyRequest policy;
    ...
    public static class AssistantsV1ServicePolicy {
        ...
        @Getter private final String userSid;
...
private Tool(
    ...
    final List<AssistantsV1ServicePolicy> policies, 
