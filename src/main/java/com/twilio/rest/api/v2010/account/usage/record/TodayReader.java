...
public class TodayReader extends Reader<Today> {
    ...
    public TodayReader setCategory(final String category) {
    ...
    public ResourceSetResponse<Today> readWithResponse(
        final TwilioRestClient client
    ) {
        Request request = buildFirstPageRequest(client);
        Response response = makeRequest(client, request);
        Page<Today> page = Page.fromJson(
            "usage_records",
            response.getContent(),
            Today.class,
            client.getObjectMapper()
        );
        ResourceSet<Today> resourceSet = new ResourceSet<>(this, client, page);
    ...
    public TwilioResponse<Page<Today>> firstPageWithResponse(
        final TwilioRestClient client
    ) {
        Request request = buildFirstPageRequest(client);
        Response response = makeRequest(client, request);
    ...
    private Response makeRequest(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "Today read failed: Unable to connect to server"
            );
    ...
    private Page<Today> pageForRequest(
        final TwilioRestClient client,
        final Request request
    ) {
        Response response = makeRequest(client, request);
    ...
    @Override
    public Page<Today> previousPage(
        final Page<Today> page,
        final TwilioRestClient client
    ) {
        Request request = new Request(
            HttpMethod.GET,
