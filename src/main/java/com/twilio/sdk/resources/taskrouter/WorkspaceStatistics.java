...
import com.twilio.sdk.fetchers.taskrouter.WorkspaceStatisticsFetcher;
...
public class WorkspaceStatistics extends SidResource {
    ...
    @JsonCreator
    private WorkspaceStatistics(@JsonProperty("realtime") final String realtime, 
