...
public class WorkspaceReader extends Reader<Workspace> {
    ...
    public ResourceSetResponse<Workspace> readWithResponse(
        final TwilioRestClient client
    ) {
        Request request = buildFirstPageRequest(client);
        Response response = makeRequest(client, request);
        Page<Workspace> page = Page.fromJson(
            "workspaces",
            response.getContent(),
            Workspace.class,
            client.getObjectMapper()
        );
        ResourceSet<Workspace> resourceSet = new ResourceSet<>(
            this,
            client,
            page
        );
    ...
    public TwilioResponse<Page<Workspace>> firstPageWithResponse(
        final TwilioRestClient client
    ) {
        Request request = buildFirstPageRequest(client);
        Response response = makeRequest(client, request);
