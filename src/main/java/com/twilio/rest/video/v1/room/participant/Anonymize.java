...
public class Anonymize extends Resource {
    private static final long serialVersionUID = 76650905205215L;
    ...
    /**
     * Create a AnonymizeUpdater to execute update.
     *
     * @param pathRoomSid The SID of the room with the participant to update
     * @param pathSid The SID that identifies the resource to update
     * @return AnonymizeUpdater capable of executing the update
     */
    public static AnonymizeUpdater updater(final String pathRoomSid,
    ...
    @JsonCreator
    private Anonymize(@JsonProperty("sid")
                      final String sid,
     ...
     *
     * @return The SID of the participant
     */
