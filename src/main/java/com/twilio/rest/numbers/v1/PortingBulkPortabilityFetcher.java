...
public class PortingBulkPortabilityFetcher extends Fetcher<PortingBulkPortability> {
    ...
    public PortingBulkPortability fetch(final TwilioRestClient client) {
        ...
        if (response == null) {
        throw new ApiConnectionException("PortingBulkPortability fetch failed: Unable to connect to server");
