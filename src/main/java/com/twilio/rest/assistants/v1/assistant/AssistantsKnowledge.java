...
public class AssistantsKnowledge extends Resource {
     ...
     */
    public static AssistantsKnowledge fromJson(final String json, final ObjectMapper objectMapper) {
     ...
     * @return AssistantsKnowledge object represented by the provided JSON
     */
    public static AssistantsKnowledge fromJson(final InputStream json, final ObjectMapper objectMapper) {
        // Convert all checked exceptions to Runtime
        try {
            return objectMapper.readValue(json, AssistantsKnowledge.class);
        } catch (final JsonMappingException | JsonParseException e) {
