...
public class RoleAssignmentReader extends Reader<RoleAssignment> {
    ...
    @Override
    public ResourceSet<RoleAssignment> read(final BearerTokenTwilioRestClient client) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<RoleAssignment> firstPage(final BearerTokenTwilioRestClient client) {
    ...
    private Page<RoleAssignment> pageForRequest(final BearerTokenTwilioRestClient client, final BearerTokenRequest request) {
    ...
    @Override
    public Page<RoleAssignment> previousPage(final Page<RoleAssignment> page, final BearerTokenTwilioRestClient client) {
        BearerTokenRequest request = new BearerTokenRequest(
            HttpMethod.GET,
    ...
    @Override
    public Page<RoleAssignment> nextPage(final Page<RoleAssignment> page, final BearerTokenTwilioRestClient client) {
        BearerTokenRequest request = new BearerTokenRequest(
            HttpMethod.GET,
    ...
    @Override
    public Page<RoleAssignment> getPage(final String targetUrl, final BearerTokenTwilioRestClient client) {
        BearerTokenRequest request = new BearerTokenRequest(
            HttpMethod.GET,
            targetUrl
        );
