...
import com.twilio.sdk.readers.api.v2010.account.usage.record.ThisMonthReader;
...
public class ThisMonth extends Resource {
     ...
     */
    public static ThisMonthReader read(final String accountSid) {
    ...
    @JsonCreator
    private ThisMonth(@JsonProperty("account_sid") final String accountSid, 
                      @JsonProperty("api_version") final String apiVersion, 
                      @JsonProperty("category") final ThisMonth.Category category, 
