...
public enum Fields {
    ...
    public static class LookupBatchRequest {
        ...
        @Getter private final String correlationId;
        ...
        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("fields")
        @Getter private final List<Query.Fields> fields;
        ...
        @Getter private final IdentityMatchParameters identityMatch;

        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("reassigned_number")
        @Getter private final ReassignedNumberParameters reassignedNumber;

        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("sms_pumping_risk")
        @Getter private final RiskParameters smsPumpingRisk;
    ...
    public static class LookupBatchResponse {
        ...
        @Getter private final Integer twilioErrorCode;

        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("calling_country_code")
        @Getter private final String callingCountryCode;
        ...
        @Getter private final String nationalFormat;
        ...
        @Getter private final List<String> validationErrors;

        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("caller_name")
        @Getter private final CallerName callerName;

        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("sim_swap")
        @Getter private final SimSwap simSwap;

        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("call_forwarding")
        @Getter private final CallForwarding callForwarding;

        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("line_type_intelligence")
        @Getter private final LineTypeIntelligence lineTypeIntelligence;

        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("line_status")
        @Getter private final LineStatus lineStatus;

        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("identity_match")
        @Getter private final IdentityMatch identityMatch;

        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("reassigned_number")
        @Getter private final ReassignedNumber reassignedNumber;

        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("sms_pumping_risk")
        @Getter private final SmsPumpingRisk smsPumpingRisk;

        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("phone_number_quality_score")
        @Getter private final Object phoneNumberQualityScore;

        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("pre_fill")
        @Getter private final Object preFill;
    ...
    public static class Builder {
        ...
        @JsonProperty("reassigned_number")
        private ReassignedNumber reassignedNumber;
        ...
        private Object preFill;
            ...
            @JsonInclude(JsonInclude.Include.NON_EMPTY)
            @JsonProperty("caller_name")
            public Builder callerName(CallerName callerName) {
                this.callerName = callerName;
                return this;
            }
            @JsonInclude(JsonInclude.Include.NON_EMPTY)
            @JsonProperty("sim_swap")
            public Builder simSwap(SimSwap simSwap) {
                this.simSwap = simSwap;
                return this;
            }
            @JsonInclude(JsonInclude.Include.NON_EMPTY)
            @JsonProperty("call_forwarding")
            public Builder callForwarding(CallForwarding callForwarding) {
            ...
            @JsonInclude(JsonInclude.Include.NON_EMPTY)
            @JsonProperty("line_status")
            public Builder lineStatus(LineStatus lineStatus) {
                this.lineStatus = lineStatus;
                return this;
            }
            @JsonInclude(JsonInclude.Include.NON_EMPTY)
            @JsonProperty("identity_match")
            public Builder identityMatch(IdentityMatch identityMatch) {
                this.identityMatch = identityMatch;
                return this;
            }
            @JsonInclude(JsonInclude.Include.NON_EMPTY)
            @JsonProperty("reassigned_number")
            public Builder reassignedNumber(ReassignedNumber reassignedNumber) {
                this.reassignedNumber = reassignedNumber;
                return this;
            }
            @JsonInclude(JsonInclude.Include.NON_EMPTY)
            @JsonProperty("sms_pumping_risk")
            public Builder smsPumpingRisk(SmsPumpingRisk smsPumpingRisk) {
                this.smsPumpingRisk = smsPumpingRisk;
                return this;
            }
            @JsonInclude(JsonInclude.Include.NON_EMPTY)
    ...
    public static class RiskParameters {
        ...
        @Getter private final String partnerSubId;
    ...
    public static class LookupRequest {
        ...
        @Getter private final List<LookupBatchRequest> phoneNumbers;
    ...
    public static class IdentityMatchParameters {
        ...
        @Getter private final String addressLine1;

        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("address_line2")
        @Getter private final String addressLine2;
        ...
        @Getter private final String postalCode;

        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("address_country_code")
        @Getter private final String addressCountryCode;

        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("national_id")
        @Getter private final String nationalId;

        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("date_of_birth")
        @Getter private final String dateOfBirth;
