...
public class SharedCostReader extends Reader<SharedCost> {
    ...
    public SharedCostReader setExcludeAllAddressRequired(
    ...
    public SharedCostReader setExcludeLocalAddressRequired(
    ...
    public SharedCostReader setExcludeForeignAddressRequired(
    ...
    public SharedCostReader setNearNumber(
    ...
    @Override
    public Page<SharedCost> previousPage(
        final Page<SharedCost> page,
        final TwilioRestClient client
    ) {
        Request request = new Request(
            HttpMethod.GET,
    ...
    @Override
    public Page<SharedCost> nextPage(
        final Page<SharedCost> page,
        final TwilioRestClient client
    ) {
        Request request = new Request(
    ...
    @Override
    public Page<SharedCost> getPage(
