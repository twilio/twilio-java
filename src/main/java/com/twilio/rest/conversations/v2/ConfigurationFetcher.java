...
public class ConfigurationFetcher
    ...
    public ConfigurationFetcher(final String pathSid) {
    ...
    @Override
    public Configuration.FetchConfigurationResponse fetch(
        final TwilioRestClient client
    ) {
        Response response = makeRequest(client);
        return Configuration.FetchConfigurationResponse.fromJson(
            response.getStream(),
            client.getObjectMapper()
        );
    }
