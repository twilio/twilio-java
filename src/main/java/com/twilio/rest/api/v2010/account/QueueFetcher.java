...
public class QueueFetcher extends Fetcher<Queue> {
    ...
    public QueueFetcher(final String pathAccountSid, final String pathSid) {
    ...
    private Response makeRequest(final TwilioRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "Queue fetch failed: Unable to connect to server"
            );
    ...
    @Override
    public TwilioResponse<Queue> fetchWithResponse(
