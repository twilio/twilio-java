...
public class Voip extends Resource {
    ...
    /**
     * Create a VoipReader to execute read.
     *
     ...
     *                        read phone numbers
     * @return VoipReader capable of executing the read
     */
    public static VoipReader reader(final String pathAccountSid,
    ...
    @JsonCreator
    private Voip(@JsonProperty("friendly_name")
