...
public class ChannelSenderReader extends Reader<ChannelSender> {
    ...
    private Page<ChannelSender> pageForRequest(final TwilioRestClient client, final Request request) {
    ...
    @Override
    public Page<ChannelSender> previousPage(final Page<ChannelSender> page, final TwilioRestClient client) {
        Request request = new Request(
            HttpMethod.GET,
    ...
    @Override
    public Page<ChannelSender> nextPage(final Page<ChannelSender> page, final TwilioRestClient client) {
        Request request = new Request(
            HttpMethod.GET,
    ...
    @Override
    public Page<ChannelSender> getPage(final String targetUrl, final TwilioRestClient client) {
        Request request = new Request(
            HttpMethod.GET,
            targetUrl
        );
