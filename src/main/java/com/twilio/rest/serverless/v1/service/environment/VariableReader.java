...
public class VariableReader extends Reader<Variable> {
    ...
    public ResourceSetResponse<Variable> readWithResponse(
        final TwilioRestClient client
    ) {
        Request request = buildFirstPageRequest(client);
        Response response = makeRequest(client, request);
        Page<Variable> page = Page.fromJson(
            "variables",
            response.getContent(),
            Variable.class,
            client.getObjectMapper()
        );
        ResourceSet<Variable> resourceSet = new ResourceSet<>(
            this,
            client,
            page
        );
    ...
    public TwilioResponse<Page<Variable>> firstPageWithResponse(
        final TwilioRestClient client
    ) {
        Request request = buildFirstPageRequest(client);
        Response response = makeRequest(client, request);
