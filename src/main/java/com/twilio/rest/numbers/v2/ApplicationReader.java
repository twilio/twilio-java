...
public class ApplicationReader extends Reader<Application> {
    ...
    public ApplicationReader setAccountSid(final String accountSid) {
        this.accountSid = accountSid;
        return this;
    }

    public ApplicationReader setIsoCountry(final String isoCountry) {
        this.isoCountry = isoCountry;
        return this;
    }

    public ApplicationReader setStatus(final String status) {
        this.status = status;
        return this;
    }
    ...
    public ApplicationReader setSid(final String sid) {
        this.sid = sid;
        return this;
    }
    ...
    public ResourceSetResponse<Application> readWithResponse(
        final TwilioRestClient client
    ) {
        Request request = buildFirstPageRequest(client);
        Response response = makeRequest(client, request);
        Page<Application> page = Page.fromJson(
            "results",
            response.getContent(),
            Application.class,
            client.getObjectMapper()
        );
        ResourceSet<Application> resourceSet = new ResourceSet<>(
            this,
            client,
            page
        );
    ...
    public TwilioResponse<Page<Application>> firstPageWithResponse(
        final TwilioRestClient client
    ) {
        Request request = buildFirstPageRequest(client);
        Response response = makeRequest(client, request);
    ...
    private Page<Application> pageForRequest(
        final TwilioRestClient client,
        final Request request
    ) {
        Response response = makeRequest(client, request);
    ...
    @Override
    public Page<Application> previousPage(
    ...
    @Override
    public Page<Application> nextPage(
        final Page<Application> page,
        final TwilioRestClient client
    ) {
        Request request = new Request(
    ...
    @Override
    public Page<Application> getPage(
