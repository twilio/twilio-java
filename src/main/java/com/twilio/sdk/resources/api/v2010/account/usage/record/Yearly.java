...
import com.twilio.sdk.readers.api.v2010.account.usage.record.YearlyReader;
...
public class Yearly extends Resource {
     ...
     * @return Yearly object represented by the provided JSON
     */
    public static Yearly fromJson(final String json, final ObjectMapper objectMapper) {
        // Convert all checked exceptions to Runtime
        try {
            return objectMapper.readValue(json, Yearly.class);
     ...
     * @return Yearly object represented by the provided JSON
     */
    public static Yearly fromJson(final InputStream json, final ObjectMapper objectMapper) {
        // Convert all checked exceptions to Runtime
        try {
            return objectMapper.readValue(json, Yearly.class);
        } catch (final JsonMappingException | JsonParseException e) {
    ...
    @JsonCreator
    private Yearly(@JsonProperty("account_sid")
                   final String accountSid, 
                   @JsonProperty("api_version")
                   final String apiVersion, 
                   @JsonProperty("category")
                   final Yearly.Category category, 
                   @JsonProperty("count")
                   final String count, 
