...
public class CredentialListMappingDeleter
    extends Deleter<CredentialListMapping> {

    private String pathAccountSid;
    private String pathDomainSid;
    private String pathSid;

    public CredentialListMappingDeleter(
    ...
    private Response makeRequest(final TwilioRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "CredentialListMapping delete failed: Unable to connect to server"
            );
