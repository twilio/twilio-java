...
public class DomainFetcher extends Fetcher<Domain> {
    ...
    public DomainFetcher(final String pathAccountSid, final String pathSid) {
    ...
    private Response makeRequest(final TwilioRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "Domain fetch failed: Unable to connect to server"
            );
    ...
    @Override
    public TwilioResponse<Domain> fetchWithResponse(
