...
public class AvailablePhoneNumberCountryReader
    ...
    @Override
    public Page<AvailablePhoneNumberCountry> previousPage(
        final Page<AvailablePhoneNumberCountry> page,
        final TwilioRestClient client
    ) {
        Request request = new Request(
            HttpMethod.GET,
    ...
    @Override
    public Page<AvailablePhoneNumberCountry> nextPage(
        final Page<AvailablePhoneNumberCountry> page,
        final TwilioRestClient client
    ) {
        Request request = new Request(
    ...
    @Override
    public Page<AvailablePhoneNumberCountry> getPage(
