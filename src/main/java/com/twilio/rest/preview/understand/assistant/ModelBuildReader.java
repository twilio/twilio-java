...
public class ModelBuildReader extends Reader<ModelBuild> {
    ...
    private Page<ModelBuild> pageForRequest(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "ModelBuild read failed: Unable to connect to server"
            );
    ...
    @Override
    public Page<ModelBuild> previousPage(
        final Page<ModelBuild> page,
        final TwilioRestClient client
    ) {
        Request request = new Request(
            HttpMethod.GET,
    ...
    @Override
    public Page<ModelBuild> nextPage(
        final Page<ModelBuild> page,
        final TwilioRestClient client
    ) {
        Request request = new Request(
    ...
    @Override
    public Page<ModelBuild> getPage(
