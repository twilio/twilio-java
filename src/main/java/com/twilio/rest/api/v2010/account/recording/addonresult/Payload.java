...
public class Payload extends Resource {
     ...
     */
    public static PayloadFetcher fetcher(final String accountSid, 
     ...
     * @return PayloadFetcher capable of executing the fetch
     */
    public static PayloadFetcher fetcher(final String referenceSid, 
                                         final String addOnResultSid, 
                                         final String sid) {
     ...
     */
    public static PayloadReader reader(final String accountSid, 
                                       final String referenceSid, 
                                       final String addOnResultSid) {
     ...
     * @return PayloadReader capable of executing the read
     */
    public static PayloadReader reader(final String referenceSid, 
                                       final String addOnResultSid) {
     ...
     */
    public static PayloadDeleter deleter(final String accountSid, 
                                         final String referenceSid, 
                                         final String addOnResultSid, 
                                         final String sid) {
     ...
     * @return PayloadDeleter capable of executing the delete
     */
    public static PayloadDeleter deleter(final String referenceSid, 
                                         final String addOnResultSid, 
                                         final String sid) {
