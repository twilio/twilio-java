...
import com.twilio.sdk.creators.api.v2010.account.incoming_phone_number.MobileCreator;
...
import com.twilio.sdk.readers.api.v2010.account.incoming_phone_number.MobileReader;
...
public class Mobile extends Resource {
     ...
     */
    public static MobileCreator create(final String ownerAccountSid, final PhoneNumber phoneNumber) {
    ...
    @JsonCreator
    private Mobile(@JsonProperty("account_sid") final String accountSid, 
                   @JsonProperty("address_requirements") final Mobile.AddressRequirement addressRequirements, 
