...
public class ApprovalFetchFetcher extends Fetcher<ApprovalFetch> {
    ...
    private Response makeRequest(final TwilioRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "ApprovalFetch fetch failed: Unable to connect to server"
            );
    ...
    @Override
    public TwilioResponse<ApprovalFetch> fetchWithResponse(
        final TwilioRestClient client
    ) {
        Response response = makeRequest(client);
        ApprovalFetch content = ApprovalFetch.fromJson(
            response.getStream(),
            client.getObjectMapper()
        );
