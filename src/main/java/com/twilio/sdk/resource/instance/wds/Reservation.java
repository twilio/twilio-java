 ...
 */
public class Reservation extends InstanceResource<TwilioWdsClient> {
	 ...
	 */
	public Reservation(final TwilioWdsClient client) {
		super(client);
	}
	 ...
	 */
	public Reservation(final TwilioWdsClient client, final Map<String, Object> properties) {
	 ...
	 */
	public Reservation(final TwilioWdsClient client, final String workspaceSid, final String taskSid,
