...
public class TaskChannelReader extends Reader<TaskChannel> {
    ...
    public ResourceSetResponse<TaskChannel> readWithResponse(
        final TwilioRestClient client
    ) {
        Request request = buildFirstPageRequest(client);
        Response response = makeRequest(client, request);
        Page<TaskChannel> page = Page.fromJson(
            "channels",
            response.getContent(),
            TaskChannel.class,
            client.getObjectMapper()
        );
        ResourceSet<TaskChannel> resourceSet = new ResourceSet<>(
            this,
            client,
            page
        );
    ...
    public TwilioResponse<Page<TaskChannel>> firstPageWithResponse(
        final TwilioRestClient client
    ) {
        Request request = buildFirstPageRequest(client);
        Response response = makeRequest(client, request);
