...
public class PhoneNumberTest {
    ...
    public void testFetchRequest() {
        ...
        try {
            PhoneNumber.fetch(new com.twilio.rest.type.PhoneNumber("+987654321")).execute();
