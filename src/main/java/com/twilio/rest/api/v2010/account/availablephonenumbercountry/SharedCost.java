...
public class SharedCost extends Resource {
    ...
    public static SharedCostReader reader(final String countryCode){
        return new SharedCostReader(countryCode);
    }
    public static SharedCostReader reader(final String accountSid, final String countryCode){
        return new SharedCostReader(accountSid, countryCode);
    }
