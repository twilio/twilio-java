...
public class Local extends Resource {
    ...
    private Local(
            ...
            @JsonProperty("emergency_address_status") final Local.EmergencyAddressStatus emergencyAddressStatus,
            @JsonProperty("emergency_status") final Local.EmergencyStatus emergencyStatus,
            ...
            @JsonProperty("voice_receive_mode") final Local.VoiceReceiveMode voiceReceiveMode,
