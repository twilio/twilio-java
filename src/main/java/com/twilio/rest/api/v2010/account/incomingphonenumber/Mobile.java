...
public class Mobile extends Resource {
    ...
    private Mobile(
            ...
            @JsonProperty("emergency_address_status") final Mobile.EmergencyAddressStatus emergencyAddressStatus,
            @JsonProperty("emergency_status") final Mobile.EmergencyStatus emergencyStatus,
            ...
            @JsonProperty("voice_receive_mode") final Mobile.VoiceReceiveMode voiceReceiveMode,
