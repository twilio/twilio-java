...
public class AuthorizationDocument extends Resource {
    ...
    public static AuthorizationDocumentCreator creator(final String addressSid, final String email, final com.twilio.type.PhoneNumber contactPhoneNumber){
        return new AuthorizationDocumentCreator(addressSid, email, contactPhoneNumber);
    }
