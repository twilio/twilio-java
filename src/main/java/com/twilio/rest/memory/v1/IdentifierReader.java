...
public class IdentifierReader
    ...
    > readWithResponse(final TwilioRestClient client) {
        ...
        Page<Identifier.ListIdentifierResponse> page = Page.fromJson(
            "identifiers",
            response.getContent(),
            Identifier.ListIdentifierResponse.class,
            client.getObjectMapper()
        );
        ResourceSet<Identifier.ListIdentifierResponse> resourceSet =
    ...
    @Override
    public ResourceSet<Identifier.ListIdentifierResponse> read(
        final TwilioRestClient client
    ) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<Identifier.ListIdentifierResponse> firstPage(
        final TwilioRestClient client
    ) {
        Request request = buildFirstPageRequest(client);
    ...
    public TwilioResponse<
        Page<Identifier.ListIdentifierResponse>
    ...
    private Response makeRequest(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "Identifier read failed: Unable to connect to server"
            );
    ...
    private Page<Identifier.ListIdentifierResponse> pageForRequest(
        final TwilioRestClient client,
        final Request request
    ) {
        Response response = makeRequest(client, request);
    ...
    @Override
    public Page<Identifier.ListIdentifierResponse> previousPage(
        final Page<Identifier.ListIdentifierResponse> page,
        final TwilioRestClient client
    ) {
        String path = "/v1/Stores/{storeId}/Profiles/{profileId}/Identifiers";
    ...
    @Override
    public Page<Identifier.ListIdentifierResponse> nextPage(
        final Page<Identifier.ListIdentifierResponse> page,
        final TwilioRestClient client
    ) {
        String path = "/v1/Stores/{storeId}/Profiles/{profileId}/Identifiers";
    ...
    @Override
    public Page<Identifier.ListIdentifierResponse> getPage(
