...
public class ApplicationReader extends Reader<Application> {
    ...
    @Override
    public Page<Application> previousPage(final Page<Application> page, final TwilioRestClient client) {
        Request request = new Request(
            HttpMethod.GET,
    ...
    @Override
    public Page<Application> nextPage(final Page<Application> page, final TwilioRestClient client) {
        Request request = new Request(
            HttpMethod.GET,
