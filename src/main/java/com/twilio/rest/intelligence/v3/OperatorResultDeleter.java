...
public class OperatorResultDeleter extends Deleter<OperatorResult> {

    private String pathOperatorResultId;

    public OperatorResultDeleter(final String pathOperatorResultId) {
    ...
    private Response makeRequest(final TwilioRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "OperatorResult delete failed: Unable to connect to server"
            );
