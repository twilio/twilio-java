...
public class BucketReader extends Reader<Bucket> {
    ...
    public ResourceSetResponse<Bucket> readWithResponse(
        final TwilioRestClient client
    ) {
        Request request = buildFirstPageRequest(client);
        Response response = makeRequest(client, request);
        Page<Bucket> page = Page.fromJson(
            "buckets",
            response.getContent(),
            Bucket.class,
            client.getObjectMapper()
        );
        ResourceSet<Bucket> resourceSet = new ResourceSet<>(this, client, page);
    ...
    public TwilioResponse<Page<Bucket>> firstPageWithResponse(
        final TwilioRestClient client
    ) {
        Request request = buildFirstPageRequest(client);
        Response response = makeRequest(client, request);
