...
public class DependentHostedNumberOrder extends Resource {
    ...
    private DependentHostedNumberOrder(
            ...
            @JsonProperty("verification_document_sid") final String verificationDocumentSid,
            @JsonProperty("verification_type") final DependentHostedNumberOrder.VerificationType verificationType
    ) {
