...
public class ItemAssignmentReader extends Reader<ItemAssignment> {
    ...
    public ResourceSetResponse<ItemAssignment> readWithResponse(
        final TwilioRestClient client
    ) {
        Request request = buildFirstPageRequest(client);
        Response response = makeRequest(client, request);
        Page<ItemAssignment> page = Page.fromJson(
            "results",
            response.getContent(),
            ItemAssignment.class,
            client.getObjectMapper()
        );
        ResourceSet<ItemAssignment> resourceSet = new ResourceSet<>(
            this,
            client,
            page
        );
    ...
    public TwilioResponse<Page<ItemAssignment>> firstPageWithResponse(
        final TwilioRestClient client
    ) {
        Request request = buildFirstPageRequest(client);
        Response response = makeRequest(client, request);
