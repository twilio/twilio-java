...
public class KeyReader extends Reader<Key> {
    ...
    public ResourceSetResponse<Key> readWithResponse(
        final TwilioRestClient client
    ) {
        Request request = buildFirstPageRequest(client);
        Response response = makeRequest(client, request);
        Page<Key> page = Page.fromJson(
            "keys",
            response.getContent(),
            Key.class,
            client.getObjectMapper()
        );
        ResourceSet<Key> resourceSet = new ResourceSet<>(this, client, page);
    ...
    public TwilioResponse<Page<Key>> firstPageWithResponse(
        final TwilioRestClient client
    ) {
        Request request = buildFirstPageRequest(client);
        Response response = makeRequest(client, request);
