...
public class PortingAllPortIn extends Resource {
    ...
    private PortingAllPortIn(
            ...
            @JsonProperty("phone_numbers_requested") final Integer phoneNumbersRequested,
            ...
            @JsonProperty("status_last_updated_timestamp") final String statusLastUpdatedTimestamp,
