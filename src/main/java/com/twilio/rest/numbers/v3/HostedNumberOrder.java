...
public class HostedNumberOrder extends Resource {
    ...
    public enum HostedNumberOrderEnumStatus {
        ...
        public static HostedNumberOrderEnumStatus forValue(final String value) {
            return Promoter.enumFromString(value, HostedNumberOrderEnumStatus.values());
        }
    }
    ...
    public enum HostedNumberOrderEnumVerificationType {
        ...
        @JsonCreator
        public static HostedNumberOrderEnumVerificationType forValue(final String value) {
            return Promoter.enumFromString(value, HostedNumberOrderEnumVerificationType.values());
        }
    }
    ...
    private HostedNumberOrder(
            ...
            @JsonProperty("incomingPhoneNumberSid") final String incomingPhoneNumberSid,
            @JsonProperty("phoneNumber") final com.twilio.type.PhoneNumber phoneNumber,
            @JsonProperty("sid") final String sid,
            @JsonProperty("signingDocumentSid") final String signingDocumentSid,
            @JsonProperty("status") final HostedNumberOrder.HostedNumberOrderEnumStatus status,
            @JsonProperty("uniqueName") final String uniqueName,
            @JsonProperty("url") final URI url,
            @JsonProperty("verificationAttempts") final Integer verificationAttempts,
            @JsonProperty("verificationCallSids") final List<String> verificationCallSids,
            @JsonProperty("verificationCode") final String verificationCode,
            @JsonProperty("verificationDocumentSid") final String verificationDocumentSid,
            @JsonProperty("verificationType") final HostedNumberOrder.HostedNumberOrderEnumVerificationType verificationType
    ) {
