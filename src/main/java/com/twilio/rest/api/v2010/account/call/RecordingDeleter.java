...
public class RecordingDeleter extends Deleter<Recording> {
    ...
    public RecordingDeleter(final String pathCallSid, final String pathSid){
        this.pathCallSid = pathCallSid;
        this.pathSid = pathSid;
    }
    public RecordingDeleter(final String pathAccountSid, final String pathCallSid, final String pathSid){
