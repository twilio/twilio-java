...
public AssistantsToolReader setPageSize(final Integer pageSize){
    ...
    private Page<AssistantsTool> pageForRequest(final TwilioRestClient client, final Request request) {
        Response response = client.request(request);
        if (response == null) {
            throw new ApiConnectionException("AssistantsTool read failed: Unable to connect to server");
    ...
    @Override
    public Page<AssistantsTool> previousPage(final Page<AssistantsTool> page, final TwilioRestClient client ) {
        Request request = new Request(HttpMethod.GET, page.getPreviousPageUrl(Domains.API.toString()));
        return pageForRequest(client, request);
    }

    @Override
    public Page<AssistantsTool> nextPage(final Page<AssistantsTool> page, final TwilioRestClient client) {
        Request request = new Request(HttpMethod.GET, page.getNextPageUrl(Domains.API.toString()));
        return pageForRequest(client, request); 
    }

    @Override
    public Page<AssistantsTool> getPage(final String targetUrl, final TwilioRestClient client) {
