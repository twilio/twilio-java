...
@ToString
public class OutboundReport extends Resource {

    public static OutboundReportCreator creator() {
        return new OutboundReportCreator();
    }
    ...
    /**
     * Converts a JSON String into a OutboundReport object using the provided ObjectMapper.
     *
     * @param json Raw JSON String
     * @param objectMapper Jackson ObjectMapper
     * @return OutboundReport object represented by the provided JSON
     */
    public static OutboundReport fromJson(
        final String json,
        final ObjectMapper objectMapper
    ) {
        // Convert all checked exceptions to Runtime
        try {
            return objectMapper.readValue(json, OutboundReport.class);
    ...
    /**
     * Converts a JSON InputStream into a OutboundReport object using the provided
     * ObjectMapper.
     *
    ...
    @Getter
    private final OutboundReport.ReportStatus status;

    @Getter
    private final URI url;

    @JsonCreator
    private OutboundReport(
        @JsonProperty("account_sid") final String accountSid,
        @JsonProperty("report_id") final String reportId,
        @JsonProperty("request_meta") final ReportMetadata requestMeta,
        @JsonProperty("status") final OutboundReport.ReportStatus status,
    ...
    public boolean equals(final Object o) {
        ...
        OutboundReport other = (OutboundReport) o;
        return (
