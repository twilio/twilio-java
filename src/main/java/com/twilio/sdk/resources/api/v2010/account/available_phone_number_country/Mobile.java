...
public class Mobile extends Resource {
     ...
     */
    public static MobileReader read(final String accountSid, final String countryCode) {
    ...
    @JsonCreator
    private Mobile(@JsonProperty("friendly_name") final com.twilio.types.PhoneNumber friendlyName, 
