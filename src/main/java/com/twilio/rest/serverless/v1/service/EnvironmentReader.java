...
public class EnvironmentReader extends Reader<Environment> {
    ...
    public ResourceSetResponse<Environment> readWithResponse(
        final TwilioRestClient client
    ) {
        Request request = buildFirstPageRequest(client);
        Response response = makeRequest(client, request);
        Page<Environment> page = Page.fromJson(
            "environments",
            response.getContent(),
            Environment.class,
            client.getObjectMapper()
        );
        ResourceSet<Environment> resourceSet = new ResourceSet<>(
            this,
            client,
            page
        );
    ...
    public TwilioResponse<Page<Environment>> firstPageWithResponse(
        final TwilioRestClient client
    ) {
        Request request = buildFirstPageRequest(client);
        Response response = makeRequest(client, request);
