...
public class CommunicationReader
    ...
    public CommunicationReader(final String pathConversationSid) {
        this.pathConversationSid = pathConversationSid;
    }

    public CommunicationReader setChannelId(final String channelId) {
        this.channelId = channelId;
        return this;
    }

    public CommunicationReader setPageSize(final Integer pageSize) {
        this.pageSize = pageSize;
        return this;
    }

    public CommunicationReader setPageToken(final String pageToken) {
    ...
    > readWithResponse(final TwilioRestClient client) {
        ...
        Page<Communication.ListCommunicationResponse> page = Page.fromJson(
            "communications",
            response.getContent(),
            Communication.ListCommunicationResponse.class,
            client.getObjectMapper()
        );
        ResourceSet<Communication.ListCommunicationResponse> resourceSet =
    ...
    @Override
    public ResourceSet<Communication.ListCommunicationResponse> read(
        final TwilioRestClient client
    ) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<Communication.ListCommunicationResponse> firstPage(
        final TwilioRestClient client
    ) {
        Request request = buildFirstPageRequest(client);
    ...
    public TwilioResponse<
        Page<Communication.ListCommunicationResponse>
    ...
    private Response makeRequest(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "Communication read failed: Unable to connect to server"
            );
    ...
    private Page<Communication.ListCommunicationResponse> pageForRequest(
        final TwilioRestClient client,
        final Request request
    ) {
        Response response = makeRequest(client, request);
    ...
    @Override
    public Page<Communication.ListCommunicationResponse> previousPage(
        final Page<Communication.ListCommunicationResponse> page,
        final TwilioRestClient client
    ) {
        String path = "/v2/Conversations/{ConversationSid}/Communications";
    ...
    @Override
    public Page<Communication.ListCommunicationResponse> nextPage(
        final Page<Communication.ListCommunicationResponse> page,
        final TwilioRestClient client
    ) {
        String path = "/v2/Conversations/{ConversationSid}/Communications";
    ...
    @Override
    public Page<Communication.ListCommunicationResponse> getPage(
