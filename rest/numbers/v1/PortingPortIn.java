...
public enum CustomerType {
    ...
    public static class NumbersV1PortingAddress {
        ...
        @Getter private final String street2;
        ...
        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("zip")
        @Getter private final String zip;
    ...
    public static class NumbersV1PortingPortInCreatePhoneNumbers {
        ...
        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("pin")
        @Getter private final String pin;
    ...
    public static class NumbersV1PortingPortInPhoneNumberResult {
        ...
        @Getter private final String notPortabilityReason;

        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("not_portability_reason_code")
        @Getter private final Integer notPortabilityReasonCode;
        ...
        @Getter private final ZonedDateTime portDate;

        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("port_in_phone_number_sid")
        @Getter private final String portInPhoneNumberSid;

        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("port_in_phone_number_status")
        @Getter private final String portInPhoneNumberStatus;
        ...
        @Getter private final String rejectionReason;

        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("rejection_reason_code")
        @Getter private final String rejectionReasonCode;

        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("status_last_time_updated_timestamp")
        @Getter private final String statusLastTimeUpdatedTimestamp;

        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("external_porting_vendor_phone_number_id")
        @Getter private final String externalPortingVendorPhoneNumberId;
    ...
    public static class NumbersV1PortingPortInCreate {
        ...
        @Getter private final String accountSid;

        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("documents")
        @Getter private final List<String> documents;

        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("phone_numbers")
        @Getter private final List<NumbersV1PortingPortInCreatePhoneNumbers> phoneNumbers;

        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("losing_carrier_information")
        @Getter private final NumbersV1PortingLosingCarrierInformation losingCarrierInformation;

        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("notification_emails")
        @Getter private final List<String> notificationEmails;

        @JsonDeserialize(using = com.twilio.converter.LocalDateDeserializer.class)
        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("target_port_in_date")
        @Getter private final LocalDate targetPortInDate;

        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("target_port_in_time_range_start")
        @Getter private final String targetPortInTimeRangeStart;

        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("target_port_in_time_range_end")
        @Getter private final String targetPortInTimeRangeEnd;

        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("bundle_sid")
        @Getter private final String bundleSid;

        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("portability_advance_carrier")
        @Getter private final String portabilityAdvanceCarrier;

        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("auto_cancel_approval_numbers")
        @Getter private final String autoCancelApprovalNumbers;
    ...
    public static class NumbersV1PortingLosingCarrierInformation {
        ...
        @Getter private final String customerName;
        ...
        @Getter private final String accountTelephoneNumber;

        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("address_sid")
        @Getter private final String addressSid;

        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("address")
        @Getter private final NumbersV1PortingAddress address;

        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("authorized_representative")
        @Getter private final String authorizedRepresentative;

        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("authorized_representative_email")
        @Getter private final String authorizedRepresentativeEmail;

        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("customer_type")
        @Getter private final PortingPortIn.CustomerType customerType;

        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("authorized_representative_katakana")
        @Getter private final String authorizedRepresentativeKatakana;

        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("sub_municipality")
        @Getter private final String subMunicipality;
        ...
        @Getter private final String katakanaName;
