...
public class SyncListItemTest {
    ...
    public void testUpdateRequest() {
        ...
        try {
            SyncListItem.updater("ISXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", "ESXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", 1, new java.util.HashMap<String, Object>()).setIfMatch("if_match").update(tw);
            fail("Expected TwilioException to be thrown for 500");
        } catch (TwilioException e) {}
    }
