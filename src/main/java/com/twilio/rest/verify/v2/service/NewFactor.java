...
public enum DiscoverableCredentials {
    ...
    public static class CreateNewPasskeysFactorRequestConfigRelyingParty {
        ...
        @Getter private final List<String> origins;
    ...
    public static class CreateNewPasskeysFactorRequestConfig {
        ...
        @Getter private final CreateNewPasskeysFactorRequestConfigRelyingParty relyingParty;

        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("authenticator_attachment")
        @Getter private final NewFactor.AuthenticatorAttachment authenticatorAttachment;

        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("discoverable_credentials")
        @Getter private final NewFactor.DiscoverableCredentials discoverableCredentials;

        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("user_verification")
        @Getter private final NewFactor.UserVerification userVerification;
    ...
    public static class CreateNewPasskeysFactorRequest {
        ...
        @JsonInclude(JsonInclude.Include.NON_EMPTY)
        @JsonProperty("config")
        @Getter private final CreateNewPasskeysFactorRequestConfig config;
...
private NewFactor(
    ...
    final NewFactor.FactorType factorType, 
    @JsonProperty("friendly_name")
