...
public class DeploymentTest {
    ...
    public void testReadRequest() {
        ...
        try {
            Deployment.reader("ZSXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", "ZEXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX").read(tw);
    ...
    public void testReadEmptyResponse() {
        ...
        assertNotNull(Deployment.reader("ZSXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", "ZEXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX").read(tw));
    }
    ...
    public void testFetchRequest() {
        ...
        try {
            Deployment.fetcher("ZSXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", "ZEXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", "ZDXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX").fetch(tw);
            fail("Expected TwilioException to be thrown for 500");
        } catch (TwilioException e) {}
    }
    ...
    public void testFetchResponse() {
        ...
        assertNotNull(Deployment.fetcher("ZSXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", "ZEXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", "ZDXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX").fetch(tw));
    }
    ...
    public void testCreateRequest() {
        ...
        try {
            Deployment.creator("ZSXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", "ZEXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX").create(tw);
            fail("Expected TwilioException to be thrown for 500");
        } catch (TwilioException e) {}
    }
