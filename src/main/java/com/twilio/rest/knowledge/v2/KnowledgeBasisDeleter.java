...
public class KnowledgeBasisDeleter
    ...
    public KnowledgeBasisDeleter(final String pathKbId) {
    ...
    private Response makeRequest(final TwilioRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "KnowledgeBasis delete failed: Unable to connect to server"
            );
    ...
    @Override
    public KnowledgeBasis.DeleteKnowledgeBasisResponse delete(
        final TwilioRestClient client
    ) {
        Response response = makeRequest(client);
        return KnowledgeBasis.DeleteKnowledgeBasisResponse.fromJson(
            response.getStream(),
            client.getObjectMapper()
        );
    }
