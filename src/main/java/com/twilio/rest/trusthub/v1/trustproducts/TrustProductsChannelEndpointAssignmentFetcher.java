...
public class TrustProductsChannelEndpointAssignmentFetcher extends Fetcher<TrustProductsChannelEndpointAssignment> {
    ...
    /**
     * Construct a new TrustProductsChannelEndpointAssignmentFetcher.
     *
     * @param pathTrustProductSid The unique string that identifies the resource.
     * @param pathSid The unique string that identifies the resource
     */
    public TrustProductsChannelEndpointAssignmentFetcher(final String pathTrustProductSid,
     ...
     * @return Fetched TrustProductsChannelEndpointAssignment
     */
    @Override
