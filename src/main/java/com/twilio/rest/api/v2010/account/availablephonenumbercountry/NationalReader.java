...
public class NationalReader extends Reader<National> {
    ...
    public ResourceSetResponse<National> readWithResponse(
        final TwilioRestClient client
    ) {
        Request request = buildFirstPageRequest(client);
        Response response = makeRequest(client, request);
        Page<National> page = Page.fromJson(
            "available_phone_numbers",
            response.getContent(),
            National.class,
            client.getObjectMapper()
        );
        ResourceSet<National> resourceSet = new ResourceSet<>(
            this,
            client,
            page
        );
    ...
    public TwilioResponse<Page<National>> firstPageWithResponse(
        final TwilioRestClient client
    ) {
        Request request = buildFirstPageRequest(client);
        Response response = makeRequest(client, request);
