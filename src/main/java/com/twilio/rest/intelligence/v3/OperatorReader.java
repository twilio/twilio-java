...
public class OperatorReader extends Reader<Operator.ListOperatorResponse> {
    ...
    public OperatorReader setPageToken(final String pageToken) {
        this.pageToken = pageToken;
        return this;
    }

    public ResourceSetResponse<Operator.ListOperatorResponse> readWithResponse(
        final TwilioRestClient client
    ) {
        Request request = buildFirstPageRequest(client);
        Response response = makeRequest(client, request);
        Page<Operator.ListOperatorResponse> page = Page.fromJson(
            "items",
            response.getContent(),
            Operator.ListOperatorResponse.class,
            client.getObjectMapper()
        );
        ResourceSet<Operator.ListOperatorResponse> resourceSet =
    ...
    @Override
    public ResourceSet<Operator.ListOperatorResponse> read(
        final TwilioRestClient client
    ) {
        return new ResourceSet<>(this, client, firstPage(client));
    }

    public Page<Operator.ListOperatorResponse> firstPage(
        final TwilioRestClient client
    ) {
        Request request = buildFirstPageRequest(client);
    ...
    public TwilioResponse<
        Page<Operator.ListOperatorResponse>
    ...
    private Page<Operator.ListOperatorResponse> pageForRequest(
        final TwilioRestClient client,
        final Request request
    ) {
        Response response = makeRequest(client, request);
    ...
    @Override
    public Page<Operator.ListOperatorResponse> previousPage(
        final Page<Operator.ListOperatorResponse> page,
        final TwilioRestClient client
    ) {
        String path = "/v3/ControlPlane/Operators";
    ...
    @Override
    public Page<Operator.ListOperatorResponse> nextPage(
        final Page<Operator.ListOperatorResponse> page,
        final TwilioRestClient client
    ) {
        String path = "/v3/ControlPlane/Operators";
    ...
    @Override
    public Page<Operator.ListOperatorResponse> getPage(
