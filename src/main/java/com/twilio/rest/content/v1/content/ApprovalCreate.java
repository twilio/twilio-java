...
public class ApprovalCreate extends Resource {
    private static final long serialVersionUID = 150858338844938L;
        ...
        @ToString
        static public class ContentApprovalRequest {
    ...
    public static ApprovalCreateCreator creator(final String pathSid, final ApprovalCreate.ContentApprovalRequest contentApprovalRequest){
    ...
    */
    ...
    public boolean equals(final Object o) {
        ...
        return Objects.equals(name, other.name) &&  Objects.equals(category, other.category) &&  Objects.equals(contentType, other.contentType) &&  Objects.equals(status, other.status) &&  Objects.equals(rejectionReason, other.rejectionReason) &&  Objects.equals(allowCategoryChange, other.allowCategoryChange)  ;
    }

    @Override
    public int hashCode() {
        return Objects.hash(name, category, contentType, status, rejectionReason, allowCategoryChange);
    }
