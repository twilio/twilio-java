...
import com.twilio.sdk.resources.api.v2010.account.usage.record.Yearly;
...
public class YearlyReader extends Reader<Yearly> {
    ...
    protected Page<Yearly> pageForRequest(final TwilioRestClient client, final Request request) {
        ...
        result.deserialize("usage_records", response.getContent(), Yearly.class, client.getObjectMapper());
