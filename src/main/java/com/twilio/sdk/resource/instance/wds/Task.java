 ...
 */
public class Task extends InstanceResource<TwilioWdsClient> {
	 ...
	 */
	public Task(final TwilioWdsClient client) {
		super(client);
	}
	 ...
	 */
	public Task(final TwilioWdsClient client, final Map<String, Object> properties) {
	 ...
	 */
	public Task(final TwilioWdsClient client, final String workspaceSid, final String taskSid) {
		super(client);
