...
public class KnowledgeUpdater extends Updater<Knowledge> {
    ...
    public KnowledgeUpdater setKnowledgeV1ServiceUpdateKnowledgeRequest(
        final Knowledge.KnowledgeV1ServiceUpdateKnowledgeRequest knowledgeV1ServiceUpdateKnowledgeRequest
    ) {
        this.knowledgeV1ServiceUpdateKnowledgeRequest =
