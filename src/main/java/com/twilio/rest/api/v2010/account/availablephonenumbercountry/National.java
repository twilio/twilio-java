...
public class National extends Resource {
    ...
    public static NationalReader reader(final String countryCode){
        return new NationalReader(countryCode);
    }
    public static NationalReader reader(final String accountSid, final String countryCode){
        return new NationalReader(accountSid, countryCode);
    }
