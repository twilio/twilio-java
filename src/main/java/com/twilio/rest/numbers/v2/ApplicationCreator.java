...
public class ApplicationCreator extends Creator<Application> {
    ...
    private Application.CreateShortCodeApplicationRequest createShortCodeApplicationRequest;

    public ApplicationCreator(
        final Application.CreateShortCodeApplicationRequest createShortCodeApplicationRequest
    ) {
        this.createShortCodeApplicationRequest =
            createShortCodeApplicationRequest;
    }

    public ApplicationCreator setCreateShortCodeApplicationRequest(
        final Application.CreateShortCodeApplicationRequest createShortCodeApplicationRequest
    ) {
        this.createShortCodeApplicationRequest =
            createShortCodeApplicationRequest;
