...
public class UserConversationReader extends Reader<UserConversation> {
    ...
    /**
     * Construct a new UserConversationReader.
     *
     ...
     * @return UserConversation ResourceSet
     */
    @Override
    ...
    public Page<UserConversation> firstPage(final TwilioRestClient client) {
        Request request = new Request(
            ...
            "/v1/Users/" + this.pathUserSid + "/Conversations"
        );
     ...
     */
    @Override
    public Page<UserConversation> nextPage(final Page<UserConversation> page,
     ...
     */
    @Override
    public Page<UserConversation> previousPage(final Page<UserConversation> page,
                                               final TwilioRestClient client) {
        Request request = new Request(
            HttpMethod.GET,
    ...
    /**
     * Generate a Page of UserConversation Resources for a given request.
     *
     * @param client TwilioRestClient with which to make the request
