...
public class BulkContacts extends Resource {
    ...
    public static BulkContactsCreator creator(final List<Object> items) {
        return new BulkContactsCreator(
             items
        );
    }
    ...
    */
    public static BulkContacts fromJson(final String json, final ObjectMapper objectMapper) {
    ...
    * @return BulkContacts object represented by the provided JSON
    */
    public static BulkContacts fromJson(final InputStream json, final ObjectMapper objectMapper) {
        // Convert all checked exceptions to Runtime
        try {
            return objectMapper.readValue(json, BulkContacts.class);
        } catch (final JsonMappingException | JsonParseException e) {
