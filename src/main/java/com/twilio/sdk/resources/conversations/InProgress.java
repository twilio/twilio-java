package com.twilio.sdk.resources.conversations;
...
import com.twilio.sdk.readers.conversations.InProgressReader;
...
public class InProgress extends SidResource {
    ...
    @JsonCreator
    private InProgress(@JsonProperty("sid") final String sid, 
                       @JsonProperty("status") final InProgress.Status status, 
