 ...
 */
public class Workflow extends InstanceResource<TwilioWdsClient> {
	 ...
	 */
	public Workflow(final TwilioWdsClient client) {
		super(client);
	}
	 ...
	 */
	public Workflow(final TwilioWdsClient client, final Map<String, Object> properties) {
	 ...
	 */
	public Workflow(final TwilioWdsClient client, final String workspaceSid, final String workflowSid) {
		super(client);
