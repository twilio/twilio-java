...
public class AssetFetcher extends Fetcher<Asset> {
    ...
    public AssetFetcher(final String serviceSid, final String sid){
    ...
    @Override
    public Asset fetch(final TwilioRestClient client) {
        ...
        if (response == null) {
        throw new ApiConnectionException("Asset fetch failed: Unable to connect to server");
