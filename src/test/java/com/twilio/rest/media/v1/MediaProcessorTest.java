...
public class MediaProcessorTest {
    ...
    public void testCreateResponse() {
        new NonStrictExpectations() {{
            ...
            result = new Response("{\"account_sid\": \"ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa\",\"date_created\": \"2015-07-30T20:00:00Z\",\"date_updated\": \"2015-07-30T20:00:00Z\",\"extension\": \"video-composer-v2\",\"extension_context\": \"{}\",\"sid\": \"ZXdeadbeefdeadbeefdeadbeefdeadbeef\",\"status\": \"started\",\"status_callback\": \"http://www.example.com\",\"status_callback_method\": \"POST\",\"ended_reason\": null,\"url\": \"https://media.twilio.com/v1/MediaProcessors/ZXdeadbeefdeadbeefdeadbeefdeadbeef\",\"max_duration\": 300}", TwilioRestClient.HTTP_STATUS_CODE_CREATED);
    ...
    public void testUpdateEndedResponse() {
        new NonStrictExpectations() {{
            twilioRestClient.request((Request) any);
            result = new Response("{\"account_sid\": \"ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa\",\"date_created\": \"2015-07-30T20:00:00Z\",\"date_updated\": \"2015-07-30T20:01:00Z\",\"extension\": \"video-composer-v2\",\"extension_context\": \"{}\",\"sid\": \"ZXdeadbeefdeadbeefdeadbeefdeadbeef\",\"status\": \"ended\",\"status_callback\": \"http://www.example.com\",\"status_callback_method\": \"POST\",\"ended_reason\": \"ended-via-api\",\"url\": \"https://media.twilio.com/v1/MediaProcessors/ZXdeadbeefdeadbeefdeadbeefdeadbeef\",\"max_duration\": 300}", TwilioRestClient.HTTP_STATUS_CODE_OK);
            twilioRestClient.getObjectMapper();
            result = new ObjectMapper();
        }};
