...
public class CallTest {
    ...
    public void testCreateRequest() {
        ...
        try {
            Call.create("ACaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", new com.twilio.rest.type.PhoneNumber("+123456789"), new com.twilio.rest.type.PhoneNumber("+987654321"), URI.create("https://example.com")).execute();
