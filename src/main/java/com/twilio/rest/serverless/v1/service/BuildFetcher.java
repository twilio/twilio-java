...
public class BuildFetcher extends Fetcher<Build> {
    ...
    public BuildFetcher(final String pathServiceSid, final String pathSid) {
    ...
    private Response makeRequest(final TwilioRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "Build fetch failed: Unable to connect to server"
            );
    ...
    @Override
    public TwilioResponse<Build> fetchWithResponse(
