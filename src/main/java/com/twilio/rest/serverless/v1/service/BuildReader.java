...
public class BuildReader extends Reader<Build> {
     ...
     */
    @Override
    public Page<Build> nextPage(final Page<Build> page,
     ...
     */
    @Override
    public Page<Build> previousPage(final Page<Build> page,
                                    final TwilioRestClient client) {
        Request request = new Request(
            HttpMethod.GET,
    ...
    /**
     * Generate a Page of Build Resources for a given request.
     *
     * @param client TwilioRestClient with which to make the request
