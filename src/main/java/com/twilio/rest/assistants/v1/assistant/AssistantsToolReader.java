...
public class AssistantsToolReader extends Reader<AssistantsTool> {
    ...
    private Response makeRequest(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "AssistantsTool read failed: Unable to connect to server"
            );
    ...
    @Override
    public Page<AssistantsTool> previousPage(
        final Page<AssistantsTool> page,
        final TwilioRestClient client
    ) {
        Request request = new Request(
            HttpMethod.GET,
    ...
    @Override
    public Page<AssistantsTool> nextPage(
        final Page<AssistantsTool> page,
        final TwilioRestClient client
    ) {
        Request request = new Request(
    ...
    @Override
    public Page<AssistantsTool> getPage(
