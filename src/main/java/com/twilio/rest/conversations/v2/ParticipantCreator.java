    ...
    extends Creator<Participant.CreateParticipantResponse>
{
    ...
    public ParticipantCreator(final String pathConversationId) {
        this.pathConversationId = pathConversationId;
    }

    public ParticipantCreator setCreateParticipantInConversationRequest(
        final Participant.CreateParticipantInConversationRequest createParticipantInConversationRequest
    ) {
        this.createParticipantInConversationRequest =
    ...
    @Override
    public Participant.CreateParticipantResponse create(
        final TwilioRestClient client
    ) {
        Response response = makeRequest(client);
        return Participant.CreateParticipantResponse.fromJson(
            response.getStream(),
            client.getObjectMapper()
        );
    }
