...
public class AssistantInitiationActions extends Resource {
    ...
    public static AssistantInitiationActionsFetcher fetcher(
        final String pathAssistantSid
    ) {
        return new AssistantInitiationActionsFetcher(pathAssistantSid);
    }

    public static AssistantInitiationActionsUpdater updater(
        final String pathAssistantSid
    ) {
     ...
     */
    public static AssistantInitiationActions fromJson(
        final String json,
        ...
        try {
            return objectMapper.readValue(
                json,
                AssistantInitiationActions.class
            );
