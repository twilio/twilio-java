...
public class CustomerProfilesTest {
    ...
    public void testCreateRequest() {
        ...
        try {
            CustomerProfiles.creator("friendly_name", "email", "RNXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX").create(tw);
    ...
    public void testFetchRequest() {
        ...
        try {
            CustomerProfiles.fetcher("BUXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX").fetch(tw);
            fail("Expected TwilioException to be thrown for 500");
        } catch (TwilioException e) {}
    }
    ...
    public void testFetchResponse() {
        ...
        assertNotNull(CustomerProfiles.fetcher("BUXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX").fetch(tw));
    }
    ...
    public void testUpdateRequest() {
        ...
        try {
            CustomerProfiles.updater("BUXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX").update(tw);
            fail("Expected TwilioException to be thrown for 500");
        } catch (TwilioException e) {}
    }
