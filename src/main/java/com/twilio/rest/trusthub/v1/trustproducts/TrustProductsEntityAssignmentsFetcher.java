...
public class TrustProductsEntityAssignmentsFetcher extends Fetcher<TrustProductsEntityAssignments> {
    ...
    /**
     * Construct a new TrustProductsEntityAssignmentsFetcher.
     *
     * @param pathTrustProductSid The unique string that identifies the resource.
     * @param pathSid The unique string that identifies the resource
     */
    public TrustProductsEntityAssignmentsFetcher(final String pathTrustProductSid,
     ...
     * @return Fetched TrustProductsEntityAssignments
     */
    @Override
