...
public class SupportingDocumentFetcher extends Fetcher<SupportingDocument> {
    ...
    private Response makeRequest(final TwilioRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "SupportingDocument fetch failed: Unable to connect to server"
            );
    ...
    @Override
    public SupportingDocument fetch(final TwilioRestClient client) {
    ...
    @Override
    public TwilioResponse<SupportingDocument> fetchWithResponse(
