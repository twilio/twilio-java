...
public class Voip extends Resource {
    ...
    public static VoipReader reader(final String countryCode){
        return new VoipReader(countryCode);
    }
    public static VoipReader reader(final String accountSid, final String countryCode){
        return new VoipReader(accountSid, countryCode);
    }
