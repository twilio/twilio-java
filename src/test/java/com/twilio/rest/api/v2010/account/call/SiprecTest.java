...
public class SiprecTest {
    ...
    public void testCreateRequest() {
        ...
        try {
            Siprec.creator("ACXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", "CAXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX").create(tw);
    ...
    public void testUpdateRequest() {
        ...
        try {
            Siprec.updater("ACXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", "CAXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", "SRXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", Siprec.UpdateStatus.STOPPED).update(tw);
            fail("Expected TwilioException to be thrown for 500");
        } catch (TwilioException e) {}
    }
