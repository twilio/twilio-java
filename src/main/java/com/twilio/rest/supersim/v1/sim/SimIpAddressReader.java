...
public class SimIpAddressReader extends Reader<SimIpAddress> {
    ...
    /**
     * Construct a new SimIpAddressReader.
     *
     ...
     * @return SimIpAddress ResourceSet
     */
    @Override
    ...
    public Page<SimIpAddress> firstPage(final TwilioRestClient client) {
        Request request = new Request(
            ...
            "/v1/Sims/" + this.pathSimSid + "/IpAddresses"
        );
     ...
     */
    @Override
    public Page<SimIpAddress> nextPage(final Page<SimIpAddress> page,
     ...
     */
    @Override
    public Page<SimIpAddress> previousPage(final Page<SimIpAddress> page,
                                           final TwilioRestClient client) {
        Request request = new Request(
            HttpMethod.GET,
    ...
    /**
     * Generate a Page of SimIpAddress Resources for a given request.
     *
     * @param client TwilioRestClient with which to make the request
