...
public class DeviceConfigFetcher extends Fetcher<DeviceConfig> {
    private String pathDeviceSid;
    private String pathKey;

    public DeviceConfigFetcher(final String pathDeviceSid, final String pathKey){
    ...
    @Override
    public DeviceConfig fetch(final TwilioRestClient client) {
        ...
        if (response == null) {
        throw new ApiConnectionException("DeviceConfig fetch failed: Unable to connect to server");
