...
public BundleReader setPageSize(final Long pageSize){
    ...
    if (regulationSid != null) {
        Serializer.toString(request, "RegulationSid", regulationSid, ParameterType.QUERY);
    }
    ...
    if (numberType != null) {
        Serializer.toString(request, "NumberType", numberType, ParameterType.QUERY);
    }
    ...
    if (hasValidUntilDate != null) {
        Serializer.toString(request, "HasValidUntilDate", hasValidUntilDate, ParameterType.QUERY);
    }
    ...
    if (sortDirection != null) {
        Serializer.toString(request, "SortDirection", sortDirection, ParameterType.QUERY);
    }
    ...
    if (validUntilDate != null) {
        Serializer.toString(request, "ValidUntilDate", validUntilDate, ParameterType.QUERY);
    }
    ...
    if (validUntilDateBefore != null) {
        Serializer.toString(request, "ValidUntilDate<", validUntilDateBefore, ParameterType.QUERY);
    }
    ...
    if (validUntilDateAfter != null) {
        Serializer.toString(request, "ValidUntilDate>", validUntilDateAfter, ParameterType.QUERY);
    }
