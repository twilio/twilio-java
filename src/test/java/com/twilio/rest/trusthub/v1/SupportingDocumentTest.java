...
public class SupportingDocumentTest {
    ...
    public void testCreateRequest() {
        ...
        try {
            SupportingDocument.creator("friendly_name", "type").create(tw);
    ...
    public void testReadRequest() {
        ...
        try {
            SupportingDocument.reader().read(tw);
            fail("Expected TwilioException to be thrown for 500");
        } catch (TwilioException e) {}
    }
    ...
    public void testReadEmptyResponse() {
        ...
        assertNotNull(SupportingDocument.reader().read(tw));
    }
    ...
    public void testFetchRequest() {
        ...
        try {
            SupportingDocument.fetcher("RDXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX").fetch(tw);
            fail("Expected TwilioException to be thrown for 500");
        } catch (TwilioException e) {}
    }
    ...
    public void testFetchResponse() {
        ...
        assertNotNull(SupportingDocument.fetcher("RDXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX").fetch(tw));
    }
    ...
    public void testUpdateRequest() {
        ...
        try {
            SupportingDocument.updater("RDXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX").update(tw);
            fail("Expected TwilioException to be thrown for 500");
        } catch (TwilioException e) {}
    }
