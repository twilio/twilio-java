...
public class FlowRevisionReader extends Reader<FlowRevision> {
    ...
    /**
     * Construct a new FlowRevisionReader.
     *
     ...
     * @return FlowRevision ResourceSet
     */
    @Override
    ...
    public Page<FlowRevision> firstPage(final TwilioRestClient client) {
        Request request = new Request(
            ...
            "/v2/Flows/" + this.pathSid + "/Revisions"
        );
     ...
     */
    @Override
    public Page<FlowRevision> nextPage(final Page<FlowRevision> page,
     ...
     */
    @Override
    public Page<FlowRevision> previousPage(final Page<FlowRevision> page,
                                           final TwilioRestClient client) {
        Request request = new Request(
            HttpMethod.GET,
    ...
    /**
     * Generate a Page of FlowRevision Resources for a given request.
     *
     * @param client TwilioRestClient with which to make the request
