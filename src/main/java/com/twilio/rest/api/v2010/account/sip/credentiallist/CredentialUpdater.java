...
public class CredentialUpdater extends Updater<Credential> {
    ...
    /**
     * The password that the username will use when authenticating SIP requests.
     * The password must be a minimum of 12 characters, contain at least 1 digit,
     * and have mixed case. (eg `IWasAtSignal2018`).
     *
