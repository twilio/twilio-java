...
public class InteractionReader extends Reader<Interaction> {
    ...
    public ResourceSetResponse<Interaction> readWithResponse(
        final TwilioRestClient client
    ) {
        Request request = buildFirstPageRequest(client);
        Response response = makeRequest(client, request);
        Page<Interaction> page = Page.fromJson(
            "interactions",
            response.getContent(),
            Interaction.class,
            client.getObjectMapper()
        );
        ResourceSet<Interaction> resourceSet = new ResourceSet<>(
            this,
            client,
            page
        );
    ...
    public TwilioResponse<Page<Interaction>> firstPageWithResponse(
        final TwilioRestClient client
    ) {
        Request request = buildFirstPageRequest(client);
        Response response = makeRequest(client, request);
    ...
    private Response makeRequest(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "Interaction read failed: Unable to connect to server"
            );
    ...
    private Page<Interaction> pageForRequest(
        final TwilioRestClient client,
        final Request request
    ) {
        Response response = makeRequest(client, request);
    ...
    @Override
    public Page<Interaction> previousPage(
        final Page<Interaction> page,
        final TwilioRestClient client
    ) {
        Request request = new Request(
            HttpMethod.GET,
    ...
    @Override
    public Page<Interaction> nextPage(
        final Page<Interaction> page,
        final TwilioRestClient client
    ) {
        Request request = new Request(
    ...
    @Override
    public Page<Interaction> getPage(
